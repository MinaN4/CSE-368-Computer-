...
var _WebGLProgram = require("./WebGLProgram.js");
...
function WebGLPrograms(renderer, extensions, capabilities) {
  ...
  function getTextureEncodingFromMap(map, gammaOverrideLinear) {
    ...
    if (encoding === _constants.LinearEncoding && gammaOverrideLinear) {
      encoding = _constants.GammaEncoding;
    }
  ...
  this.getParameters = function (material, lights, shadows, fog, nClipPlanes, nClipIntersection, object) {
    ...
    var parameters = {
      ...
      envMapCubeUV: !!material.envMap && (material.envMap.mapping === _constants.CubeUVReflectionMapping || material.envMap.mapping === _constants.CubeUVRefractionMapping),
  ...
  this.acquireProgram = function (material, shader, parameters, cacheKey) {
    ...
    if (program === undefined) {
      program = new _WebGLProgram.WebGLProgram(renderer, extensions, cacheKey, material, shader, parameters);
