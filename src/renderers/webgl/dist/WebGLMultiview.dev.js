...
exports.WebGLMultiview = WebGLMultiview;

var _WebGLMultiviewRenderTarget = require("../WebGLMultiviewRenderTarget.js");
  ...
  function isAvailable() {
    if (available === undefined) {
      ...
      if (available) {
        ...
        renderTarget = new _WebGLMultiviewRenderTarget.WebGLMultiviewRenderTarget(0, 0, DEFAULT_NUMVIEWS);
        renderSize = new _Vector.Vector2();
        mat4 = [];
        mat3 = [];
        cameraArray = [];

        for (var i = 0; i < maxNumViews; i++) {
          mat4[i] = new _Matrix2.Matrix4();
          mat3[i] = new _Matrix.Matrix3();
        }
      }
    }
