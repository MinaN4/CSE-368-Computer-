...
function WebXRManager(renderer, gl) {
  ...
  cameraL.viewport = new _Vector.Vector4();
  var cameraR = new _PerspectiveCamera.PerspectiveCamera();
  cameraR.layers.enable(2);
  cameraR.viewport = new _Vector.Vector4();
...
Object.assign(WebXRManager.prototype, _EventDispatcher.EventDispatcher.prototype);