...
function VertexNormalsHelper(object, size, hex, linewidth) {
  ...
  var positions = new _BufferAttribute.Float32BufferAttribute(nNormals * 2 * 3, 3);
...
VertexNormalsHelper.prototype = Object.create(_LineSegments.LineSegments.prototype);
