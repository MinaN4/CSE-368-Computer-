...
function PositionalAudioHelper(audio, range, divisionsInnerAngle, divisionsOuterAngle) {
  ...
  var materialInnerAngle = new _LineBasicMaterial.LineBasicMaterial({
    color: 0x00ff00
  });
  var materialOuterAngle = new _LineBasicMaterial.LineBasicMaterial({
    color: 0xffff00
  });

  _Line.Line.call(this, geometry, [materialOuterAngle, materialInnerAngle]);

  this.update();
}

PositionalAudioHelper.prototype = Object.create(_Line.Line.prototype);
...
PositionalAudioHelper.prototype.update = function () {
  ...
  var coneInnerAngle = _Math2._Math.degToRad(audio.panner.coneInnerAngle);

  var coneOuterAngle = _Math2._Math.degToRad(audio.panner.coneOuterAngle);
