...
var _AnimationAction = require("./AnimationAction.js");
...
var _PropertyBinding = require("./PropertyBinding.js");

var _PropertyMixer = require("./PropertyMixer.js");

var _AnimationClip = require("./AnimationClip.js");
...
AnimationMixer.prototype = Object.assign(Object.create(_EventDispatcher.EventDispatcher.prototype), {
  ...
  _lendControlInterpolant: function _lendControlInterpolant() {
    ...
    if (interpolant === undefined) {
      interpolant = new _LinearInterpolant.LinearInterpolant(new Float32Array(2), new Float32Array(2), 1, this._controlInterpolantsResultBuffer);
  ...
  clipAction: function clipAction(clip, optionalRoot) {
    ...
    var newAction = new _AnimationAction.AnimationAction(this, clipObject, optionalRoot);
