...
function KeyframeTrack(name, times, values, interpolation) {
  ...
  this.name = name;
  this.times = _AnimationUtils.AnimationUtils.convertArray(times, this.TimeBufferType);
  this.values = _AnimationUtils.AnimationUtils.convertArray(values, this.ValueBufferType);
...
Object.assign(KeyframeTrack, {
  ...
  toJSON: function toJSON(track) {
    ...
    if (trackType.toJSON !== undefined) {
      ...
      json = {
        'name': track.name,
        'times': _AnimationUtils.AnimationUtils.convertArray(track.times, Array),
        'values': _AnimationUtils.AnimationUtils.convertArray(track.values, Array)
      };
...
Object.assign(KeyframeTrack.prototype, {
  ...
  trim: function trim(startTime, endTime) {
    ...
    if (from !== 0 || to !== nKeys) {
      ...
      this.times = _AnimationUtils.AnimationUtils.arraySlice(times, from, to);
      this.values = _AnimationUtils.AnimationUtils.arraySlice(this.values, from * stride, to * stride);
    }
  ...
  validate: function validate() {
    ...
    if (values !== undefined) {
      if (_AnimationUtils.AnimationUtils.isTypedArray(values)) {
  ...
  optimize: function optimize() {
    ...
    if (writeIndex !== times.length) {
      this.times = _AnimationUtils.AnimationUtils.arraySlice(times, 0, writeIndex);
      this.values = _AnimationUtils.AnimationUtils.arraySlice(values, 0, writeIndex * stride);
    }

    return this;
  },
  clone: function clone() {
    var times = _AnimationUtils.AnimationUtils.arraySlice(this.times, 0);

    var values = _AnimationUtils.AnimationUtils.arraySlice(this.values, 0);
