...
function AnimationObjectGroup() {
  this.uuid = _Math2._Math.generateUUID(); // cached objects followed by the active ones
      ...
      if (index === undefined) {
        ...
        for (var j = 0, m = nBindings; j !== m; ++j) {
          ...
          if (binding === undefined) {
            ...
            // or may not exist
            binding = new _PropertyBinding.PropertyBinding(object, paths[j], parsedPaths[j]);
          }
