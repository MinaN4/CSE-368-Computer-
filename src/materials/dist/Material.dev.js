...
function Material() {
  ...
  this.vertexColors = _constants.NoColors; // THREE.NoColors, THREE.VertexColors, THREE.FaceColors
...
Material.prototype = Object.assign(Object.create(_EventDispatcher.EventDispatcher.prototype), {
  ...
  toJSON: function toJSON(meta) {
    ...
    if (this.vertexColors !== _constants.NoColors) data.vertexColors = this.vertexColors;
