...
LatheGeometry.prototype = Object.create(_Geometry.Geometry.prototype);
...
function LatheBufferGeometry(points, segments, phiStart, phiLength) {
  ...
  phiLength = _Math2._Math.clamp(phiLength, 0, Math.PI * 2); // buffers
  ...
  this.setAttribute('uv', new _BufferAttribute.Float32BufferAttribute(uvs, 2)); // generate normals
  ...
  if (phiLength === Math.PI * 2) {
    ...
    var n1 = new _Vector.Vector3();
    var n2 = new _Vector.Vector3();
    var n = new _Vector.Vector3(); // this is the buffer offset for the last line of vertices
...
LatheBufferGeometry.prototype = Object.create(_BufferGeometry.BufferGeometry.prototype);
