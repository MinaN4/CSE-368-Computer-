...
function EdgesGeometry(geometry, thresholdAngle) {
  ...
  var thresholdDot = Math.cos(_Math2._Math.DEG2RAD * thresholdAngle);
  var edge = [0, 0],
      edges = {},
      edge1,
      edge2;
  ...
  if (geometry.isBufferGeometry) {
    geometry2 = new _Geometry.Geometry();
...
EdgesGeometry.prototype = Object.create(_BufferGeometry.BufferGeometry.prototype);
