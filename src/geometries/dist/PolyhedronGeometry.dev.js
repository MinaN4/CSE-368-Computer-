...
PolyhedronGeometry.prototype = Object.create(_Geometry.Geometry.prototype);
...
function PolyhedronBufferGeometry(vertices, indices, radius, detail) {
  ...
  function subdivide(detail) {
    ...
    var c = new _Vector.Vector3(); // iterate over all faces and apply a subdivison with the given detail value
  ...
  function applyRadius(radius) {
    var vertex = new _Vector.Vector3(); // iterate over the entire buffer and apply the radius to each vertex
...
PolyhedronBufferGeometry.prototype = Object.create(_BufferGeometry.BufferGeometry.prototype);
