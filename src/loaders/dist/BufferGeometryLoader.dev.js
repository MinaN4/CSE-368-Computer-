...
BufferGeometryLoader.prototype = Object.assign(Object.create(_Loader.Loader.prototype), {
    ...
    if (morphAttributes) {
      for (var key in morphAttributes) {
        ...
        for (var i = 0, il = attributeArray.length; i < il; i++) {
          ...
          var typedArray = new TYPED_ARRAYS[attribute.type](attribute.array);
          var bufferAttribute = new _BufferAttribute.BufferAttribute(typedArray, attribute.itemSize, attribute.normalized);
          if (attribute.name !== undefined) bufferAttribute.name = attribute.name;
