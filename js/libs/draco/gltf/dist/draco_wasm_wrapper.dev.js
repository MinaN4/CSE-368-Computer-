...
var DracoDecoderModule = function DracoDecoderModule(d) {
  ...
  var l = {
    ...
    prepare: function prepare() {
      if (l.needed) {
        for (var c = 0; c < l.temps.length; c++) {
          a._free(l.temps[c]);
        }
  ...
  q.prototype.HasEntry = q.prototype.HasEntry = function (a, b) {
    ...
    l.prepare();
    a && "object" === _typeof(a) && (a = a.ptr);
    b = b && "object" === _typeof(b) ? b.ptr : U(b);
    return !!Ec(c, a, b);
  };
  ...
  g.prototype.GetAttributeIdByMetadataEntry = g.prototype.GetAttributeIdByMetadataEntry = function (a, b, d) {
    ...
    a && "object" === _typeof(a) && (a = a.ptr);
    b = b && "object" === _typeof(b) ? b.ptr : U(b);
    d = d && "object" === _typeof(d) ? d.ptr : U(d);
    return Ib(c, a, b, d);
  };
...
"object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = DracoDecoderModule : "function" === typeof define && define.amd ? define([], function () {
  return DracoDecoderModule;
}) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && (exports.DracoDecoderModule = DracoDecoderModule);