...
$jscomp.polyfill("Promise", function (d) {
  ...
  function n(d) {
    return d instanceof g ? d : new g(function (f, D) {
      f(d);
    });
  }
  ...
  g.prototype.resolveTo_ = function (d) {
    if (d === this) this.reject_(new TypeError("A Promise cannot resolve to itself"));else if (d instanceof g) this.settleSameAsPromise_(d);else {
      a: switch (_typeof(d)) {
        case "object":
          var f = null != d;
          break a;
  ...
  g.prototype.callWhenSettled_ = function (d, f) {
    ...
    var n = this;
    null == this.onSettledCallbacks_ ? ma.asyncExecute(g) : this.onSettledCallbacks_.push(function () {
      ma.asyncExecute(g);
    });
  };
  ...
  g.race = function (d) {
    return new g(function (f, g) {
      for (var u = $jscomp.makeIterator(d), w = u.next(); !w.done; w = u.next()) {
  ...
  g.all = function (d) {
    var f = $jscomp.makeIterator(d),
        u = f.next();
    return u.done ? n([]) : new g(function (d, g) {
      function w(f) {
        return function (g) {
          D[f] = g;
          Q--;
      ...
      do {
        D.push(void 0), Q++, n(u.value).callWhenSettled_(w(D.length - 1), g), u = f.next();
      } while (!u.done);
    });
  };
...
var DracoDecoderModule = function DracoDecoderModule(d) {
  ...
  function Q(e, b) {
    ...
    try {
      var c = v.get(),
          ...
          d = v.get();
      e = 0;
      Q.buffer || (Q.buffers = [null, [], []], Q.printChar = function (b, c) {
        var e = Q.buffers[b];
        f(e);
        ...
        if (0 === c || 10 === c) {
          ...
          a: {
            ...
            if (16 < l - c && e.subarray && Ua) c = Ua.decode(e.subarray(c, l));else for (l = "";;) {
              var d = e[c++];
              ...
              if (d & 128) {
                var g = e[c++] & 63;
                if (192 == (d & 224)) l += String.fromCharCode((d & 31) << 6 | g);else {
                  var h = e[c++] & 63;
                  if (224 == (d & 240)) d = (d & 15) << 12 | g << 6 | h;else {
                    var E = e[c++] & 63;
                    if (240 == (d & 248)) d = (d & 7) << 18 | g << 12 | h << 6 | E;else {
                      var k = e[c++] & 63;
                      if (248 == (d & 252)) d = (d & 3) << 24 | g << 18 | h << 12 | E << 6 | k;else {
                        var ta = e[c++] & 63;
      ...
      for (b = 0; b < d; b++) {
        for (var h = x[l + 8 * b >> 2], g = x[l + (8 * b + 4) >> 2], k = 0; k < g; k++) {
          Q.printChar(c, T[h + k]);
        }
  ...
  var oa = !1,
      ...
      wa = !1;
  if (a.ENVIRONMENT) {
    if ("WEB" === a.ENVIRONMENT) oa = !0;else if ("WORKER" === a.ENVIRONMENT) ka = !0;else if ("NODE" === a.ENVIRONMENT) pa = !0;else if ("SHELL" === a.ENVIRONMENT) wa = !0;else throw Error("The provided Module['ENVIRONMENT'] value is not valid. It must be one of: WEB|WORKER|NODE|SHELL.");
  } else oa = "object" === (typeof window === "undefined" ? "undefined" : _typeof(window)), ka = "function" === typeof importScripts, pa = "object" === (typeof process === "undefined" ? "undefined" : _typeof(process)) && "function" === typeof require && !oa && !ka, wa = !oa && !pa && !ka;
  ...
  if (pa) {
  ...
  } else if (wa) a.print || (a.print = print), "undefined" != typeof printErr && (a.printErr = printErr), a.read = "undefined" != typeof read ? function (a) {
    return read(a);
  } : function () {
    ...
    f("object" === _typeof(a));
    return a;
  }, "undefined" != typeof scriptArgs ? a.arguments = scriptArgs : "undefined" != typeof arguments && (a.arguments = arguments), "function" === typeof quit && (a.quit = function (a, b) {
    quit(a);
  });else if (oa || ka) a.read = function (a) {
    var b = new XMLHttpRequest();
    b.open("GET", a, !1);
    b.send(null);
    return b.responseText;
  }, ka && (a.readBinary = function (a) {
    var b = new XMLHttpRequest();
    b.open("GET", a, !1);
    ...
    e.onerror = c;
    e.send(null);
  }, "undefined" != typeof arguments && (a.arguments = arguments), "undefined" !== typeof console ? (a.print || (a.print = function (a) {
    console.log(a);
  }), a.printErr || (a.printErr = function (a) {
    console.warn(a);
  })) : a.print || (a.print = function (a) {}), "undefined" === typeof a.setWindowTitle && (a.setWindowTitle = function (a) {
    document.title = a;
  ...
  var m = {
    ...
    getNativeTypeSize: function getNativeTypeSize(a) {
      switch (a) {
        case "i1":
        case "i8":
          return 1;
    ...
    getNativeFieldSize: function getNativeFieldSize(a) {
      return Math.max(m.getNativeTypeSize(a), m.QUANTUM_SIZE);
    },
    STACK_ALIGN: 16,
    prepVararg: function prepVararg(a, b) {
      "double" === b || "i64" === b ? a & 7 && (f(4 === (a & 7)), a += 4) : f(0 === (a & 3));
      return a;
    },
    getAlignSize: function getAlignSize(a, b, c) {
      return c || "i64" != a && "double" != a ? a ? Math.min(b || (a ? m.getNativeFieldSize(a) : 0), m.QUANTUM_SIZE) : Math.min(b, 8) : 8;
    },
    dynCall: function dynCall(e, b, c) {
      return c && c.length ? a["dynCall_" + e].apply(null, [b].concat(c)) : a["dynCall_" + e].call(null, b);
    },
    functionPointers: [],
    addFunction: function addFunction(a) {
      for (var b = 0; b < m.functionPointers.length; b++) {
        if (!m.functionPointers[b]) return m.functionPointers[b] = a, 2 * (1 + b);
      }

      throw "Finished up all reserved function pointers. Use a higher value for RESERVED_FUNCTION_POINTERS.";
    },
    removeFunction: function removeFunction(a) {
    ...
    funcWrappers: {},
    getFuncWrapper: function getFuncWrapper(a, b) {
      if (a) {
        f(b);
    ...
    getCompilerSetting: function getCompilerSetting(a) {
    ...
    staticAlloc: function staticAlloc(a) {
      var b = aa;
      aa = aa + a | 0;
      aa = aa + 15 & -16;
      return b;
    },
    dynamicAlloc: function dynamicAlloc(a) {
      var b = x[ba >> 2];
      a = (b + a + 15 | 0) & -16;
      x[ba >> 2] = a;
      return a >= y && !Ma() ? (x[ba >> 2] = b, 0) : b;
    },
    alignMemory: function alignMemory(a, b) {
      return Math.ceil(a / (b ? b : 16)) * (b ? b : 16);
    },
    makeBigInt: function makeBigInt(a, b, c) {
  ...
  a.reallocBuffer || (a.reallocBuffer = function (a) {
    try {
      if (ArrayBuffer.transfer) var b = ArrayBuffer.transfer(F, a);else {
        var c = fa;
        b = new ArrayBuffer(a);
  ...
  if (a.buffer) var F = a.buffer;else "object" === (typeof WebAssembly === "undefined" ? "undefined" : _typeof(WebAssembly)) && "function" === typeof WebAssembly.Memory ? (a.wasmMemory = new WebAssembly.Memory({
    initial: y / Aa
  ...
  (function () {
    ...
    function b() {
      return a.wasmBinary || !oa && !ka || "function" !== typeof fetch ? new Promise(function (a, b) {
        a(e());
      }) : fetch(d, {
    ...
    function c(c, e, l) {
      ...
      a.wasmBinary || "function" !== typeof WebAssembly.instantiateStreaming || 0 === d.indexOf("data:") || "function" !== typeof fetch ? k(E) : WebAssembly.instantiateStreaming(fetch(d, {
        credentials: "same-origin"
      }), g).then(E)["catch"](function (b) {
    ...
    a.asm = function (b, e, d) {
      ...
      (b = c(b, e, d)) || W("no binaryen method succeeded. consider enabling more options, like interpreting, if you want that: https://github.com/kripken/emscripten/wiki/WebAssembly#binaryen-methods");
      return b;
    };
  })();
  ...
  var A = {
    ...
    deAdjust: function deAdjust(a) {
      ...
      for (var b in A.infos) {
        if (A.infos[b].adjusted === a) return b;
      }
  ...
  a.asmLibraryArg = {
    ...
    invoke_ii: function invoke_ii(e, b) {
      try {
    ...
    invoke_iii: function invoke_iii(e, b, c) {
      try {
    ...
    invoke_iiii: function invoke_iiii(e, b, c, d) {
      try {
    ...
    invoke_iiiiiii: function invoke_iiiiiii(e, b, c, d, f, g, h) {
      try {
    ...
    invoke_vi: function invoke_vi(e, b) {
      try {
        a.dynCall_vi(e, b);
      } catch (c) {
        if ("number" !== typeof c && "longjmp" !== c) throw c;
    ...
    invoke_vii: function invoke_vii(e, b, c) {
      try {
        a.dynCall_vii(e, b, c);
      } catch (l) {
        if ("number" !== typeof l && "longjmp" !== l) throw l;
    ...
    invoke_viii: function invoke_viii(e, b, c, d) {
      try {
    ...
    invoke_viiii: function invoke_viiii(e, b, c, d, f) {
      try {
    ...
    invoke_viiiii: function invoke_viiiii(e, b, c, d, f, g) {
      try {
    ...
    invoke_viiiiii: function invoke_viiiiii(e, b, c, d, f, g, h) {
      try {
    ...
    ___cxa_throw: function ___cxa_throw(a, b, c) {
      A.infos[a] = {
        ptr: a,
        adjusted: a,
        type: b,
    ...
    ___setErrNo: function ___setErrNo(e) {
    ...
    _pthread_key_create: function _pthread_key_create(a, b) {
      if (0 == a) return 22;
      x[a >> 2] = La;
      ya[La] = 0;
      La++;
    ...
    _pthread_once: ra,
    _pthread_setspecific: function _pthread_setspecific(a, b) {
  ...
  a.asm = eb;
  if (V) if ("function" === typeof a.locateFile ? V = a.locateFile(V) : a.memoryInitializerPrefixURL && (V = a.memoryInitializerPrefixURL + V), pa || wa) {
    ...
    if (a.memoryInitializerRequest) {
      var hb = function hb() {
        var d = a.memoryInitializerRequest,
            b = d.response;
        200 !== d.status && 0 !== d.status ? (console.warn("a problem seems to have happened with Module.memoryInitializerRequest, status: " + d.status + ", retrying " + V), gb()) : fb(b);
      };
  ...
  r.prototype.HasEntry = r.prototype.HasEntry = function (a, c) {
    ...
    k.prepare();
    a && "object" === _typeof(a) && (a = a.ptr);
    c = c && "object" === _typeof(c) ? c.ptr : Y(c);
    return !!Sc(b, a, c);
  };
  ...
  R.prototype.Init = R.prototype.Init = function (a, c) {
    ...
    if ("object" == _typeof(a) && "object" === _typeof(a)) {
      var d = k.alloc(a, fa);
      k.copy(a, fa, d);
      a = d;
    }
  ...
  h.prototype.GetAttributeIdByMetadataEntry = h.prototype.GetAttributeIdByMetadataEntry = function (a, c, d) {
    ...
    a && "object" === _typeof(a) && (a = a.ptr);
    c = c && "object" === _typeof(c) ? c.ptr : Y(c);
    d = d && "object" === _typeof(d) ? d.ptr : Y(d);
    return Wb(b, a, c, d);
  };
