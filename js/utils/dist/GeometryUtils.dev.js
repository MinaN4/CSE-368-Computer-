...
THREE.GeometryUtils = {
  ...
  randomPointsInBufferGeometry: function randomPointsInBufferGeometry(geometry, n) {
    ...
    vC = new THREE.Vector3(); // geometry._areas = [];
    ...
    for (i = 0; i < n; i++) {
      r = Math.random() * totalArea;
      index = binarySearchIndices(r); // result[ i ] = THREE.GeometryUtils.randomPointInFace( faces[ index ], geometry, true );
  ...
  hilbert2D: function hilbert2D(center, size, iterations, v0, v1, v2, v3) {
    ...
    if (0 <= --iterations) {
      ...
      Array.prototype.push.apply(tmp, THREE.GeometryUtils.hilbert2D(vec[3], half, iterations, v2, v1, v0, v3)); // Return recursive call
  ...
  hilbert3D: function hilbert3D(center, size, iterations, v0, v1, v2, v3, v4, v5, v6, v7) {
    ...
    if (--iterations >= 0) {
      ...
      Array.prototype.push.apply(tmp, THREE.GeometryUtils.hilbert3D(vec[7], half, iterations, v6, v5, v2, v1, v0, v3, v4, v7)); // Return recursive call
