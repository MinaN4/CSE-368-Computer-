...
THREE.MD2CharacterComplex = function () {
  ...
  this.updateMovementModel = function (delta) {
    ...
    if (controls.moveBackward) this.speed = THREE.Math.clamp(this.speed - delta * this.backAcceleration, this.maxReverseSpeed, this.maxSpeed); // orientation based on controls
