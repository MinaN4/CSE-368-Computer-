...
THREE.WebGLDeferredRenderer = function (parameters) {
  ...
  var _tmpMaterial = new THREE.ShaderMaterial({
    visible: false
  });

  var _tmpVector3 = new THREE.Vector3(); // scene/material/light cache for deferred rendering.
  ...
  function initDepthTexture() {
    _depthTexture = new THREE.DepthTexture(_width, _height, THREE.UnsignedInt248Type, undefined, undefined, undefined, undefined, undefined, undefined, THREE.DepthStencilFormat);
  }
