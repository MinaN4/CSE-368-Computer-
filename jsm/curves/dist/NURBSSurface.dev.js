 ...
 *	NURBS surface
 **************************************************************/
var NURBSSurface = function NURBSSurface(degree1, degree2, knots1, knots2
/* arrays of reals */
, controlPoints
/* array^2 of Vector(2|3|4) */
  ...
  for (var i = 0; i < len1; ++i) {
    ...
    for (var j = 0; j < len2; ++j) {
      ...
      this.controlPoints[i][j] = new _threeModule.Vector4(point.x, point.y, point.z, point.w);
    }
  }
};
...
NURBSSurface.prototype = {
  ...
  getPoint: function getPoint(t1, t2, target) {
    ...
    _NURBSUtils.NURBSUtils.calcSurfacePoint(this.degree1, this.degree2, this.knots1, this.knots2, this.controlPoints, u, v, target);
  }
};