...
exports.CinematicCamera = void 0;

var _threeModule = require("../../../build/three.module.js");

var _BokehShader = require("../shaders/BokehShader2.js");
...
var CinematicCamera = function CinematicCamera(fov, aspect, near, far) {
  _threeModule.PerspectiveCamera.call(this, fov, aspect, near, far);
  ...
  var depthShader = _BokehShader.BokehDepthShader;
  this.materialDepth = new _threeModule.ShaderMaterial({
...
CinematicCamera.prototype = Object.create(_threeModule.PerspectiveCamera.prototype);
...
CinematicCamera.prototype.initPostProcessing = function () {
  if (this.postprocessing.enabled) {
    this.postprocessing.scene = new _threeModule.Scene();
    this.postprocessing.camera = new _threeModule.OrthographicCamera(window.innerWidth / -2, window.innerWidth / 2, window.innerHeight / 2, window.innerHeight / -2, -10000, 10000);
    ...
    this.postprocessing.rtTextureDepth = new _threeModule.WebGLRenderTarget(window.innerWidth, window.innerHeight, pars);
    this.postprocessing.rtTextureColor = new _threeModule.WebGLRenderTarget(window.innerWidth, window.innerHeight, pars);
    var bokeh_shader = _BokehShader.BokehShader;
    this.postprocessing.bokeh_uniforms = _threeModule.UniformsUtils.clone(bokeh_shader.uniforms);
    ...
    this.postprocessing.materialBokeh = new _threeModule.ShaderMaterial({
    ...
    this.postprocessing.quad = new _threeModule.Mesh(new _threeModule.PlaneBufferGeometry(window.innerWidth, window.innerHeight), this.postprocessing.materialBokeh);
