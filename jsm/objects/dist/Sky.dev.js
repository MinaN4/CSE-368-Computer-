...
var Sky = function Sky() {
  ...
  _threeModule.Mesh.call(this, new _threeModule.BoxBufferGeometry(1, 1, 1), material);
};

exports.Sky = Sky;
Sky.prototype = Object.create(_threeModule.Mesh.prototype);
Sky.SkyShader = {
  uniforms: {
    "luminance": {
      value: 1
    ...
    "up": {
      value: new _threeModule.Vector3(0, 1, 0)
    }
  },
