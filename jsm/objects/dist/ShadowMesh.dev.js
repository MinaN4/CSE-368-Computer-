 ...
 */
var ShadowMesh = function ShadowMesh(mesh) {
  var shadowMaterial = new _threeModule.MeshBasicMaterial({
    color: 0x000000,
    transparent: true,
    opacity: 0.6,
    depthWrite: false
  ...
  _threeModule.Mesh.call(this, mesh.geometry, shadowMaterial);
...
ShadowMesh.prototype = Object.create(_threeModule.Mesh.prototype);
ShadowMesh.prototype.constructor = ShadowMesh;

ShadowMesh.prototype.update = function () {
  var shadowMatrix = new _threeModule.Matrix4();
