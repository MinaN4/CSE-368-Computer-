 ...
 *
 */
var Fire = function Fire(geometry, options) {
  ...
  this.color1 = options.color1 || new _threeModule.Color(0xffffff);
  this.color2 = options.color2 || new _threeModule.Color(0xffa000);
  this.color3 = options.color3 || new _threeModule.Color(0x000000);
  ...
  this.windVector = options.windVector || new _threeModule.Vector2(0.0, 0.75);
  ...
  this.field0 = new _threeModule.WebGLRenderTarget(textureWidth, textureHeight, parameters);
  this.field0.background = new _threeModule.Color(0x000000);
  this.field1 = new _threeModule.WebGLRenderTarget(textureWidth, textureHeight, parameters);
  this.field0.background = new _threeModule.Color(0x000000);
  this.fieldProj = new _threeModule.WebGLRenderTarget(textureWidth, textureHeight, parameters);
  this.field0.background = new _threeModule.Color(0x000000);
  ...
  this.fieldScene = new _threeModule.Scene();
  this.fieldScene.background = new _threeModule.Color(0x000000);
  this.orthoCamera = new _threeModule.OrthographicCamera(textureWidth / -2, textureWidth / 2, textureHeight / 2, textureHeight / -2, 1, 2);
  this.orthoCamera.position.z = 1;
  this.fieldGeometry = new _threeModule.PlaneBufferGeometry(textureWidth, textureHeight);
  this.internalSource = new _threeModule.DataTexture(this.sourceData, textureWidth, textureHeight, _threeModule.RGBAFormat); // Source Shader

  var shader = Fire.SourceShader;
  this.sourceMaterial = new _threeModule.ShaderMaterial({
  ...
  this.clearSources();
  this.sourceMesh = new _threeModule.Mesh(this.fieldGeometry, this.sourceMaterial);
  this.fieldScene.add(this.sourceMesh); // Diffuse Shader

  var shader = Fire.DiffuseShader;
  this.diffuseMaterial = new _threeModule.ShaderMaterial({
    uniforms: shader.uniforms,
    vertexShader: shader.vertexShader,
    fragmentShader: shader.fragmentShader,
    transparent: false
  ...
  this.diffuseMesh = new _threeModule.Mesh(this.fieldGeometry, this.diffuseMaterial);
  this.fieldScene.add(this.diffuseMesh); // Drift Shader

  shader = Fire.DriftShader;
  this.driftMaterial = new _threeModule.ShaderMaterial({
    uniforms: shader.uniforms,
    vertexShader: shader.vertexShader,
    fragmentShader: shader.fragmentShader,
    transparent: false
  ...
  this.driftMesh = new _threeModule.Mesh(this.fieldGeometry, this.driftMaterial);
  this.fieldScene.add(this.driftMesh); // Projection Shader 1

  shader = Fire.ProjectionShader1;
  this.projMaterial1 = new _threeModule.ShaderMaterial({
    uniforms: shader.uniforms,
    vertexShader: shader.vertexShader,
    fragmentShader: shader.fragmentShader,
    transparent: false
  ...
  this.projMesh1 = new _threeModule.Mesh(this.fieldGeometry, this.projMaterial1);
  this.fieldScene.add(this.projMesh1); // Projection Shader 2

  shader = Fire.ProjectionShader2;
  this.projMaterial2 = new _threeModule.ShaderMaterial({
    uniforms: shader.uniforms,
    vertexShader: shader.vertexShader,
    fragmentShader: shader.fragmentShader,
    transparent: false
  ...
  this.projMesh2 = new _threeModule.Mesh(this.fieldGeometry, this.projMaterial2);
  this.fieldScene.add(this.projMesh2); // Projection Shader 3

  shader = Fire.ProjectionShader3;
  this.projMaterial3 = new _threeModule.ShaderMaterial({
    uniforms: shader.uniforms,
    vertexShader: shader.vertexShader,
    fragmentShader: shader.fragmentShader,
    transparent: false
  ...
  this.projMesh3 = new _threeModule.Mesh(this.fieldGeometry, this.projMaterial3);
  ...
  this.onBeforeRender = function (renderer) {
    ...
    renderer.toneMapping = _threeModule.NoToneMapping;
    this.sourceMesh.visible = false;
    this.diffuseMesh.visible = false;
    this.driftMesh.visible = false;
    this.projMesh1.visible = false;
    ...
    this.material.minFilter = _threeModule.LinearFilter, this.material.magFilter = _threeModule.LinearFilter, this.restoreRenderState(renderer);
  };
};

exports.Fire = Fire;
Fire.prototype = Object.create(_threeModule.Mesh.prototype);
...
Fire.DriftShader = {
  uniforms: {
    ...
    'windVector': {
      value: new _threeModule.Vector2(0.0, 0.0)
    },
    'airSpeed': {
      value: null
    },
