...
exports.SkinShaderBeckmann = exports.SkinShaderAdvanced = exports.SkinShaderBasic = void 0;
...
var SkinShaderBasic = {
  uniforms: _threeModule.UniformsUtils.merge([_threeModule.UniformsLib["fog"], _threeModule.UniformsLib["lights"], {
    ...
    "diffuse": {
      value: new _threeModule.Color(0xeeeeee)
    },
    "specular": {
      value: new _threeModule.Color(0x111111)
    },
    "opacity": {
      value: 1
    },
    ...
    "offsetRepeat": {
      value: new _threeModule.Vector4(0, 0, 1, 1)
    },
    "uWrapRGB": {
      value: new _threeModule.Vector3(0.75, 0.375, 0.1875)
    }
  }]),
  vertexShader: ["uniform vec4 offsetRepeat;", "varying vec3 vNormal;", "varying vec2 vUv;", "varying vec3 vViewPosition;", _threeModule.ShaderChunk["common"], _threeModule.ShaderChunk["lights_pars_begin"], _threeModule.ShaderChunk["fog_pars_vertex"], "void main() {", "	vec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );", "	vec4 worldPosition = modelMatrix * vec4( position, 1.0 );", "	vViewPosition = -mvPosition.xyz;", "	vNormal = normalize( normalMatrix * normal );", "	vUv = uv * offsetRepeat.zw + offsetRepeat.xy;", "	gl_Position = projectionMatrix * mvPosition;", _threeModule.ShaderChunk["fog_vertex"], "}"].join("\n"),
  fragmentShader: ["#define USE_BUMPMAP", "uniform bool enableBump;", "uniform bool enableSpecular;", "uniform vec3 diffuse;", "uniform vec3 specular;", "uniform float opacity;", "uniform float uRoughness;", "uniform float uSpecularBrightness;", "uniform vec3 uWrapRGB;", "uniform sampler2D tDiffuse;", "uniform sampler2D tBeckmann;", "uniform sampler2D specularMap;", "varying vec3 vNormal;", "varying vec2 vUv;", "varying vec3 vViewPosition;", _threeModule.ShaderChunk["common"], _threeModule.ShaderChunk["bsdfs"], _threeModule.ShaderChunk["packing"], _threeModule.ShaderChunk["lights_pars_begin"], _threeModule.ShaderChunk["fog_pars_fragment"], _threeModule.ShaderChunk["bumpmap_pars_fragment"], // Fresnel term
  ...
  _threeModule.ShaderChunk["fog_fragment"], "}"].join("\n")
};
/* ------------------------------------------------------------------------------------------
//	Skin shader
...
exports.SkinShaderBasic = SkinShaderBasic;
...
exports.SkinShaderAdvanced = SkinShaderAdvanced;
...
exports.SkinShaderBeckmann = SkinShaderBeckmann;