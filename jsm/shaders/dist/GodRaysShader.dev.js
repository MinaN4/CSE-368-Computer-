...
exports.GodRaysFakeSunShader = exports.GodRaysCombineShader = exports.GodRaysGenerateShader = exports.GodRaysDepthMaskShader = void 0;
...
var GodRaysCombineShader = {
  ...
  vertexShader: ["varying vec2 vUv;", "void main() {", "	vUv = uv;", "	gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );", "}"].join("\n"),
  fragmentShader: ["varying vec2 vUv;", "uniform sampler2D tColors;", "uniform sampler2D tGodRays;", "uniform vec2 vSunPositionScreenSpace;", "uniform float fGodRayIntensity;", "void main() {", // Since THREE.MeshDepthMaterial renders foreground objects white and background
...
var GodRaysFakeSunShader = {
  uniforms: {
    ...
    sunColor: {
      value: new _threeModule.Color(0xffee00)
    },
    bgColor: {
