...
var GeometryUtils = {
  ...
  merge: function merge(geometry1, geometry2, materialIndexOffset) {
    ...
    if (geometry2 instanceof _threeModule.Mesh) {
  ...
  randomPointsInBufferGeometry: function randomPointsInBufferGeometry(geometry, n) {
    ...
    vA = new _threeModule.Vector3();
    vB = new _threeModule.Vector3();
    vC = new _threeModule.Vector3(); // geometry._areas = [];
    ...
    for (i = 0; i < n; i++) {
      r = Math.random() * totalArea;
      index = binarySearchIndices(r); // result[ i ] = GeometryUtils.randomPointInFace( faces[ index ], geometry, true );
  ...
  hilbert2D: function hilbert2D(center, size, iterations, v0, v1, v2, v3) {
    // Default Vars
    var center = center !== undefined ? center : new _threeModule.Vector3(0, 0, 0),
    ...
    var vec_s = [new _threeModule.Vector3(center.x - half, center.y, center.z - half), new _threeModule.Vector3(center.x - half, center.y, center.z + half), new _threeModule.Vector3(center.x + half, center.y, center.z + half), new _threeModule.Vector3(center.x + half, center.y, center.z - half)];
  ...
  hilbert3D: function hilbert3D(center, size, iterations, v0, v1, v2, v3, v4, v5, v6, v7) {
    ...
    var vec_s = [new _threeModule.Vector3(center.x - half, center.y + half, center.z - half), new _threeModule.Vector3(center.x - half, center.y + half, center.z + half), new _threeModule.Vector3(center.x - half, center.y - half, center.z + half), new _threeModule.Vector3(center.x - half, center.y - half, center.z - half), new _threeModule.Vector3(center.x + half, center.y - half, center.z - half), new _threeModule.Vector3(center.x + half, center.y - half, center.z + half), new _threeModule.Vector3(center.x + half, center.y + half, center.z + half), new _threeModule.Vector3(center.x + half, center.y + half, center.z - half)];
