...
var UVsDebug = function UVsDebug(geometry, size) {
  ...
  var abc = 'abc';
  var a = new _threeModule.Vector2();
  var b = new _threeModule.Vector2();
  var uvs = [new _threeModule.Vector2(), new _threeModule.Vector2(), new _threeModule.Vector2()];
  var face = [];
  ...
  function processFace(face, uvs, index) {
    ...
    ctx.fillStyle = 'rgba( 0, 0, 0, 1.0 )'; // label uv edge orders
