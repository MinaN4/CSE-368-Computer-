...
var PMREMGenerator = function () {
  ...
  var camera = new _threeModule.OrthographicCamera(-1, 1, 1, -1, 0.0, 1000);
  var scene = new _threeModule.Scene();
  var planeMesh = new _threeModule.Mesh(new _threeModule.PlaneBufferGeometry(2, 2, 0), shader);
  planeMesh.material.side = _threeModule.DoubleSide;
  scene.add(planeMesh);
  scene.add(camera);
  ...
  var PMREMGenerator = function PMREMGenerator(sourceTexture, samplesPerLevel, resolution) {
    ...
    var monotonicEncoding = this.sourceTexture.encoding === _threeModule.LinearEncoding || this.sourceTexture.encoding === _threeModule.GammaEncoding || this.sourceTexture.encoding === _threeModule.sRGBEncoding;
    this.sourceTexture.minFilter = monotonicEncoding ? _threeModule.LinearFilter : _threeModule.NearestFilter;
    this.sourceTexture.magFilter = monotonicEncoding ? _threeModule.LinearFilter : _threeModule.NearestFilter;
    ...
    for (var i = 0; i < this.numLods; i++) {
      var renderTarget = new _threeModule.WebGLRenderTargetCube(size, size, params);
