...
var _CCDIKSolver = require("../animation/CCDIKSolver.js");

var _MMDPhysics = require("../animation/MMDPhysics.js");
...
var MMDAnimationHelper = function () {
  ...
  function MMDAnimationHelper(params) {
    ...
    this.meshes = [];
    this.camera = null;
    this.cameraTarget = new _threeModule.Object3D();
  ...
  MMDAnimationHelper.prototype = {
    ...
    _setupMeshAnimation: function _setupMeshAnimation(mesh, animation) {
      ...
      if (animation !== undefined) {
        ...
        objects.mixer = new _threeModule.AnimationMixer(mesh);
    ...
    _setupCameraAnimation: function _setupCameraAnimation(camera, animation) {
      ...
      objects.mixer = new _threeModule.AnimationMixer(camera);
