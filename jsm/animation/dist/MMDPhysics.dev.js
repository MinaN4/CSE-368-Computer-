...
var MMDPhysics = function () {
  ...
  function MMDPhysics(mesh, rigidBodyParams, constraintParams, params) {
    ...
    this.gravity = new _threeModule.Vector3(0, -9.8 * 10, 0);
  ...
  ResourceManager.prototype = {
    ...
    allocThreeVector3: function allocThreeVector3() {
      return this.threeVector3s.length > 0 ? this.threeVector3s.pop() : new _threeModule.Vector3();
    },
    freeThreeVector3: function freeThreeVector3(v) {
      this.threeVector3s.push(v);
    },
    allocThreeMatrix4: function allocThreeMatrix4() {
      return this.threeMatrix4s.length > 0 ? this.threeMatrix4s.pop() : new _threeModule.Matrix4();
    },
    freeThreeMatrix4: function freeThreeMatrix4(m) {
      this.threeMatrix4s.push(m);
    },
    allocThreeQuaternion: function allocThreeQuaternion() {
      return this.threeQuaternions.length > 0 ? this.threeQuaternions.pop() : new _threeModule.Quaternion();
    },
    freeThreeQuaternion: function freeThreeQuaternion(q) {
      this.threeQuaternions.push(q);
    },
    allocThreeEuler: function allocThreeEuler() {
      return this.threeEulers.length > 0 ? this.threeEulers.pop() : new _threeModule.Euler();
    },
  ...
  RigidBody.prototype = {
    ...
    _init: function _init() {
      ...
      var bone = params.boneIndex === -1 ? new _threeModule.Bone() : bones[params.boneIndex];
  ...
  function MMDPhysicsHelper(mesh, physics) {
    ...
    this.materials = [];
    this.materials.push(new _threeModule.MeshBasicMaterial({
      color: new _threeModule.Color(0xff8888),
      wireframe: true,
      depthTest: false,
      depthWrite: false,
      opacity: 0.25,
    ...
    this.materials.push(new _threeModule.MeshBasicMaterial({
      color: new _threeModule.Color(0x88ff88),
      wireframe: true,
      depthTest: false,
      depthWrite: false,
      opacity: 0.25,
    ...
    this.materials.push(new _threeModule.MeshBasicMaterial({
      color: new _threeModule.Color(0x8888ff),
      wireframe: true,
      depthTest: false,
      depthWrite: false,
      opacity: 0.25,
  ...
  MMDPhysicsHelper.prototype = Object.assign(Object.create(_threeModule.Object3D.prototype), {
    ...
    updateMatrixWorld: function () {
      ...
      var matrixWorldInv = new _threeModule.Matrix4();
      return function updateMatrixWorld(force) {
        ...
        _threeModule.Object3D.prototype.updateMatrixWorld.call(this, force);
      };
    }(),
    // private method
    _init: function _init() {
      ...
      function createGeometry(param) {
        switch (param.shapeType) {
          case 0:
            return new _threeModule.SphereBufferGeometry(param.width, 16, 8);

          case 1:
            return new _threeModule.BoxBufferGeometry(param.width * 2, param.height * 2, param.depth * 2, 8, 8, 8);
      ...
      function createCapsuleGeometry(radius, cylinderHeight, segmentsRadius, segmentsHeight) {
        var geometry = new _threeModule.CylinderBufferGeometry(radius, radius, cylinderHeight, segmentsRadius, segmentsHeight, true);
        var upperSphere = new _threeModule.Mesh(new _threeModule.SphereBufferGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, 0, Math.PI / 2));
        var lowerSphere = new _threeModule.Mesh(new _threeModule.SphereBufferGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, Math.PI / 2, Math.PI / 2));
      ...
      for (var i = 0, il = bodies.length; i < il; i++) {
        ...
        this.add(new _threeModule.Mesh(createGeometry(param), this.materials[param.type]));
      }
    }
  });
  return MMDPhysics;
