...
var CCDIKSolver = function () {
  ...
  CCDIKSolver.prototype = {
     ...
     */
    update: function () {
      var q = new _threeModule.Quaternion();
      var targetPos = new _threeModule.Vector3();
      var targetVec = new _threeModule.Vector3();
      var effectorPos = new _threeModule.Vector3();
      var effectorVec = new _threeModule.Vector3();
      var linkPos = new _threeModule.Vector3();
      var invLinkQ = new _threeModule.Quaternion();
      var linkScale = new _threeModule.Vector3();
  ...
  function CCDIKHelper(mesh, iks) {
    ...
    this.sphereGeometry = new _threeModule.SphereBufferGeometry(0.25, 16, 8);
    this.targetSphereMaterial = new _threeModule.MeshBasicMaterial({
      color: new _threeModule.Color(0xff8888),
      depthTest: false,
      depthWrite: false,
      transparent: true
    });
    this.effectorSphereMaterial = new _threeModule.MeshBasicMaterial({
      color: new _threeModule.Color(0x88ff88),
      depthTest: false,
      depthWrite: false,
      transparent: true
    });
    this.linkSphereMaterial = new _threeModule.MeshBasicMaterial({
      color: new _threeModule.Color(0x8888ff),
      depthTest: false,
      depthWrite: false,
      transparent: true
    });
    this.lineMaterial = new _threeModule.LineBasicMaterial({
      color: new _threeModule.Color(0xff0000),
      depthTest: false,
      depthWrite: false,
      transparent: true
    });
  ...
  CCDIKHelper.prototype = Object.assign(Object.create(_threeModule.Object3D.prototype), {
    ...
    _init: function _init() {
      ...
      function createLineGeometry(ik) {
        ...
        geometry.setAttribute('position', new _threeModule.BufferAttribute(vertices, 3));
        return geometry;
      }

      function createTargetMesh() {
        return new _threeModule.Mesh(self.sphereGeometry, self.targetSphereMaterial);
      }

      function createEffectorMesh() {
        return new _threeModule.Mesh(self.sphereGeometry, self.effectorSphereMaterial);
      }

      function createLinkMesh() {
        return new _threeModule.Mesh(self.sphereGeometry, self.linkSphereMaterial);
      }

      function createLine(ik) {
        return new _threeModule.Line(createLineGeometry(ik), self.lineMaterial);
      }
