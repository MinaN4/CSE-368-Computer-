...
exports.RaytracingRenderer = void 0;
 ...
 */
var RaytracingRenderer = function RaytracingRenderer(parameters) {
  ...
  var clearColor = new _threeModule.Color(0x000000);
    ...
    while (pool.length < workers) {
      ...
      worker.onmessage = function (e) {
        ...
        if (data.blockSize && sceneId == data.sceneId) {
          ...
          context.putImageData(imagedata, data.blockX, data.blockY); // completed
      ...
      worker.color = new _threeModule.Color().setHSL(Math.random(), 0.8, 0.8).getHexString();
      pool.push(worker);
  ...
  var materials = {};
  var sceneJSON, cameraJSON, reallyThen; // additional properties that were not serialize automatically
  ...
  this.render = function (scene, camera) {
    renderering = true; // update scene graph
...
Object.assign(RaytracingRenderer.prototype, _threeModule.EventDispatcher.prototype);