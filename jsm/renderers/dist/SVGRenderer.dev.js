...
var _Projector = require("../renderers/Projector.js");
...
SVGObject.prototype = Object.create(_threeModule.Object3D.prototype);
...
var SVGRenderer = function SVGRenderer() {
  var _this = this,
      ...
      _v2,
      _v3,
      _clipBox = new _threeModule.Box2(),
      _elemBox = new _threeModule.Box2(),
      _color = new _threeModule.Color(),
      _diffuseColor = new _threeModule.Color(),
      _ambientLight = new _threeModule.Color(),
      _directionalLights = new _threeModule.Color(),
      _pointLights = new _threeModule.Color(),
      _clearColor = new _threeModule.Color(),
      _clearAlpha = 1,
      _vector3 = new _threeModule.Vector3(),
      // Needed for PointLight
  _centroid = new _threeModule.Vector3(),
      _normal = new _threeModule.Vector3(),
      _normalViewMatrix = new _threeModule.Matrix3(),
  ...
  this.render = function (scene, camera) {
    if (camera instanceof _threeModule.Camera === false) {
