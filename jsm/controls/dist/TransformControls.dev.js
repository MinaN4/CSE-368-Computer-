...
var TransformControlsGizmo = function TransformControlsGizmo() {
  ...
  lineGeometry.setAttribute('position', new _threeModule.Float32BufferAttribute([0, 0, 0, 1, 0, 0], 3));
  ...
  var TranslateHelperGeometry = function TranslateHelperGeometry() {
    var geometry = new _threeModule.BufferGeometry();
    geometry.setAttribute('position', new _threeModule.Float32BufferAttribute([0, 0, 0, 1, 1, 1], 3));
    return geometry;
