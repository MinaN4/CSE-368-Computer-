...
function NodeMaterial(vertex, fragment) {
  _threeModule.ShaderMaterial.call(this);
  ...
  this.updaters = []; // onBeforeCompile can't be in the prototype because onBeforeCompile.toString varies per material
...
NodeMaterial.prototype = Object.create(_threeModule.ShaderMaterial.prototype);
...
NodeMaterial.prototype.build = function (params) {
  ...
  this.transparent = builder.requires.transparent || this.blending > _threeModule.NormalBlending;
  return this;
};
...
NodeMaterial.prototype.toJSON = function (meta) {
  ...
  if (!meta.materials[this.uuid]) {
    ...
    if (this.blending !== _threeModule.NormalBlending) data.blending = this.blending;
    if (this.flatShading === true) data.flatShading = this.flatShading;
    if (this.side !== _threeModule.FrontSide) data.side = this.side;
    if (this.vertexColors !== _threeModule.NoColors) data.vertexColors = this.vertexColors;
    if (this.depthFunc !== _threeModule.LessEqualDepth) data.depthFunc = this.depthFunc;
