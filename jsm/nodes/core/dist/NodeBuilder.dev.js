...
NodeBuilder.prototype = {
      ...
      if (nodeCandidate !== undefined) {
        if (nodeCandidate.isNode) {
          ...
          switch (nodeCandidate.mapping) {
            case _threeModule.CubeReflectionMapping:
            case _threeModule.CubeRefractionMapping:
              return new _CubeTextureNode.CubeTextureNode(nodeCandidate);
              break;

            case _threeModule.CubeUVReflectionMapping:
            case _threeModule.CubeUVRefractionMapping:
  ...
  getTextureEncodingFromMap: function getTextureEncodingFromMap(map, gammaOverrideLinear) {
    ...
    if (!map) {
      encoding = _threeModule.LinearEncoding;
    ...
    if (encoding === _threeModule.LinearEncoding && gammaOverrideLinear) {
      encoding = _threeModule.GammaEncoding;
    }
