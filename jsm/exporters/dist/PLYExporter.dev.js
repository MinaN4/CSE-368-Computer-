  ...
  parse: function parse(object, onDone, options) {
    ...
    object.traverse(function (child) {
      if (child.isMesh === true) {
        ...
        if (geometry.isGeometry === true) {
          var bufferGeometry = geomToBufferGeom.get(geometry) || new _threeModule.BufferGeometry().setFromObject(mesh);
    ...
    var header = 'ply\n' + "format ".concat(options.binary ? 'binary_big_endian' : 'ascii', " 1.0\n") + "element vertex ".concat(vertexCount, "\n") + // position
    'property float x\n' + 'property float y\n' + 'property float z\n';
    ...
    if (includeIndices === true) {
      // faces
      header += "element face ".concat(faceCount, "\n") + "property list uchar uint".concat(indexByteCount * 8, " vertex_index\n");
    }
    ...
    if (options.binary === true) {
      ...
      traverseMeshes(function (mesh, geometry) {
        ...
        if (includeIndices === true) {
          ...
          var faceIndexFunc = "setUint".concat(indexByteCount * 8);
      ...
      result = "".concat(header).concat(vertexList, "\n").concat(includeIndices ? "".concat(faceList, "\n") : '');
    }
