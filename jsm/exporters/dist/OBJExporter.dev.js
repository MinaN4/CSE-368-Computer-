...
OBJExporter.prototype = {
  ...
  parse: function parse(object) {
    ...
    var uv = new _threeModule.Vector2();
    var i,
        j,
        k,
        l,
    ...
    var parseMesh = function parseMesh(mesh) {
      ...
      var normalMatrixWorld = new _threeModule.Matrix3();
      ...
      if (geometry instanceof _threeModule.BufferGeometry) {
        ...
        if (vertices !== undefined) {
          for (i = 0, l = vertices.count; i < l; i++, nbVertex++) {
            ...
            vertex.z = vertices.getZ(i); // transfrom the vertex to world space
        ...
        if (normals !== undefined) {
          ...
          for (i = 0, l = normals.count; i < l; i++, nbNormals++) {
            ...
            normal.z = normals.getZ(i); // transfrom the normal to world space
    ...
    var parseLine = function parseLine(line) {
      ...
      if (geometry instanceof _threeModule.Geometry) {
        geometry = new _threeModule.BufferGeometry().setFromObject(line);
      }
    ...
    object.traverse(function (child) {
      if (child instanceof _threeModule.Mesh) {
        parseMesh(child);
      }

      if (child instanceof _threeModule.Line) {
        parseLine(child);
      }
    });
    return output;
