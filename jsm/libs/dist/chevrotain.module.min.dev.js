...
!function (t, e) {
  ...
  return function (t) {
    ...
    var u = function (t) {
      ...
      return i(e, t), Object.defineProperty(e.prototype, "definition", {
        get: function get() {
    ...
    var o = n(4),
        ...
        v = n(37),
        g = n(38);
    e.END_OF_FILE = u.createTokenInstance(u.EOF, "", NaN, NaN, NaN, NaN, NaN, NaN), Object.freeze(e.END_OF_FILE), e.DEFAULT_PARSER_CONFIG = Object.freeze({
      recoveryEnabled: !1,
      maxLookahead: 4,
      ignoredIssues: {},
    ...
    function T(t, n) {
      var r = [],
          i = t.name;
      return i.match(e.validTermsPattern) || r.push({
    ...
    function v(t, n, r) {
      var i,
          o = [];
      return n.name.match(e.validNestedRuleName) || (i = r.buildInvalidNestedRuleNameError(t, n), o.push({
        message: i,
    ...
    function g(t, n) {
      var r = [];
      return c.tokenName(t).match(e.validTermsPattern) || r.push({
    ...
    function A(t) {
      ...
      var n = o.first(t);
      if (n instanceof f.NonTerminal) e.push(n.referencedRule);else if (n instanceof f.Flat || n instanceof f.Option || n instanceof f.RepetitionMandatory || n instanceof f.RepetitionMandatoryWithSeparator || n instanceof f.RepetitionWithSeparator || n instanceof f.Repetition) e = e.concat(A(n.definition));else if (n instanceof f.Alternation) e = o.flatten(o.map(n.definition, function (t) {
    ...
    e.OccurrenceValidationCollector = y, e.validTermsPattern = /^[a-zA-Z_]\w*$/, e.validNestedRuleName = new RegExp(e.validTermsPattern.source.replace("^", "^\\$")), e.validateRuleName = T, e.validateNestedRuleName = v, e.validateTokenName = g, e.validateRuleDoesNotAlreadyExist = _, e.validateRuleIsOverridden = function (t, e, n) {
      var r,
          i = [];
      return o.contains(e, t) || (r = "Invalid rule override, rule: ->" + t + "<- cannot be overridden in the grammar: ->" + n + "<-as it is not defined in any of the super grammars ", i.push({
        message: r,
        type: s.ParserDefinitionErrorType.INVALID_RULE_OVERRIDE,
        ruleName: t
      })), i;
    }, e.validateNoLeftRecursion = R, e.getFirstNoneTerminal = A;
    ...
    function S(t, e, n, r) {
      ...
      var c = i.alternations,
          l = n[t.name];
      return l && (c = a.reject(c, function (t) {
        ...
        var u = i.idx,
          ...
          var i = [],
            ...
            return a.forEach(n, function (n) {
              ...
              }), o.length > 1 && !p.containsPath(i, n) && (i.push(n), e.push({
                alts: o,
                path: n
              }));
            }), e;
      ...
      if (e) return function (e) {
        for (var r = a.map(e, function (t) {
          ...
          var s = t[o],
              u = s.length,
              c = r[o];
          if (void 0 === c || !1 !== c.call(this)) t: for (var p = 0; p < u; p++) {
      ...
      function r(t, e) {
        return void 0 === a.find(t, function (t) {
          return a.every(e, function (e, n) {
            return r = e, i = t[n], r === i || r && i && (r.categoryMatchesMap[i.tokenTypeIdx] || i.categoryMatchesMap[r.tokenTypeIdx]);
            var r, i;
          });
        });
      }
    ...
    var l = function (t) {
      function e(e, n) {
        ...
        return r.path = n, r.nextTerminalName = "", r.nextTerminalOccurrence = 0, r.nextTerminalName = s.tokenName(r.path.lastTok), r.nextTerminalOccurrence = r.path.lastTokOccurrence, r;
      }
    ...
    var f = function (t) {
      ...
      return i(e, t), e.prototype.walkMany = function (e, n, r) {
        if (e.idx === this.occurrence) {
          ...
          this.result.isEndOfRule = void 0 === i, i instanceof c.Terminal && (this.result.token = i.terminalType, this.result.occurrence = i.idx);
    ...
    e.NextTerminalAfterAtLeastOneSepWalker = m, e.possiblePathsFrom = function t(e, n, r) {
      ...
      for (; r.length < n && o < e.length;) {
        ...
        if (u instanceof c.Option) i = s(u.definition);else {
          if (u instanceof c.RepetitionMandatory) return s(p = u.definition.concat([new c.Repetition({
            definition: u.definition
          })]));
          if (u instanceof c.RepetitionMandatoryWithSeparator) return s(p = [new c.Flat({
            definition: u.definition
          }), new c.Repetition({
          ...
          if (u instanceof c.RepetitionWithSeparator) {
            var p = u.definition.concat([new c.Repetition({
              definition: [new c.Terminal({
                terminalType: u.separator
              })].concat(u.definition)
            })]);
            i = s(p);
          } else if (u instanceof c.Repetition) p = u.definition.concat([new c.Repetition({
            definition: u.definition
          })]), i = s(p);else {
          ...
          if (!a.isEmpty(f)) {
            ...
            if ("EXIT_NONE_TERMINAL" === T) {
              ...
              A = {
                ...
                ruleStack: E,
                occurrenceStack: m
              }, l.push(A), l.push("EXIT_ALTERNATIVE"), S = new c.Terminal({
                terminalType: T.separator
              });
            ...
            } else if (T instanceof c.Repetition) A = {
              idx: d,
              def: a.drop(f),
              ruleStack: E,
              occurrenceStack: m
            }, l.push(A), l.push("EXIT_ALTERNATIVE"), I = new c.Repetition({
              definition: T.definition,
              idx: T.idx
            }), N = {
              idx: d,
              ...
              ruleStack: E,
              occurrenceStack: m
            }, l.push(N);else if (T instanceof c.Alternation) for (var L = T.definition.length - 1; L >= 0; L--) {
              var k = {
                idx: d,
            ...
            } else if (T instanceof c.Flat) l.push({
              idx: d,
              def: T.definition.concat(a.drop(f)),
              ruleStack: E,
              occurrenceStack: m
    ...
    var r = n(0),
      ...
      return t.prototype.walk = function (t, e) {
        ...
        void 0 === e && (e = []), r.forEach(t.definition, function (o, a) {
          ...
          if (o instanceof i.NonTerminal) n.walkProdRef(o, s, e);else if (o instanceof i.Terminal) n.walkTerminal(o, s, e);else if (o instanceof i.Flat) n.walkFlat(o, s, e);else if (o instanceof i.Option) n.walkOption(o, s, e);else if (o instanceof i.RepetitionMandatory) n.walkAtLeastOne(o, s, e);else if (o instanceof i.RepetitionMandatoryWithSeparator) n.walkAtLeastOneSep(o, s, e);else if (o instanceof i.RepetitionWithSeparator) n.walkManySep(o, s, e);else if (o instanceof i.Repetition) n.walkMany(o, s, e);else {
    ...
    var u = function () {
      function t(t, e) {
        var n = this;
        if (void 0 === e && (e = s), this.lexerDefinition = t, this.lexerDefinitionErrors = [], this.lexerDefinitionWarning = [], this.patternIdxToConfig = {}, this.charCodeToPatternIdxToConfig = {}, this.modes = [], this.emptyGroups = {}, this.config = void 0, this.trackStartLines = !0, this.trackEndLines = !0, this.hasCustom = !1, this.canModeBeOptimized = {}, "boolean" == typeof e) throw Error("The second argument to the Lexer constructor is now an ILexerConfig Object.\na boolean 2nd argument is no longer supported");
        if (this.config = i.merge(s, e), this.config.lineTerminatorsPattern === s.lineTerminatorsPattern) this.config.lineTerminatorsPattern = r.LineTerminatorOptimizedTester;else if (this.config.lineTerminatorCharacters === s.lineTerminatorCharacters) throw Error("Error: Missing <lineTerminatorCharacters> property on the Lexer config.\n\tFor details See: https://sap.github.io/chevrotain/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS");
        ...
        if (i.forEach(a.modes, function (t, a) {
          if (n.modes.push(a), n.lexerDefinitionErrors = n.lexerDefinitionErrors.concat(r.validatePatterns(t, c)), i.isEmpty(n.lexerDefinitionErrors)) {
            ...
            n.patternIdxToConfig[a] = s.patternIdxToConfig, n.charCodeToPatternIdxToConfig[a] = s.charCodeToPatternIdxToConfig, n.emptyGroups = i.merge(n.emptyGroups, s.emptyGroups), n.hasCustom = s.hasCustom || n.hasCustom, n.canModeBeOptimized[a] = s.canBeOptimized;
          }
        ...
        var l = i.reduce(this.canModeBeOptimized, function (t, e, n) {
      ...
      return t.prototype.tokenize = function (t, e) {
        ...
        var F,
          ...
          if (1 === C.length && void 0 === t.tokenType.PUSH_MODE) {
            var e = m.config.errorMessageProvider.buildUnableToPopLexerModeMessage(t);
            A.push({
        ...
        function w(t) {
          C.push(t), x = this.charCodeToPatternIdxToConfig[t], P = this.patternIdxToConfig[t], k = P.length, k = P.length;
        ...
        for (w.call(this, e); v < T;) {
          ...
          for (n = 0; n < B; n++) {
            ...
            if (!1 !== (Z = F["short"]) ? U === Z && (u = K) : !0 === F.isCustom ? u = null !== (E = K.exec(y, v, R, S)) ? E[0] : E : (this.updateLastIndex(K, v), u = this.match(K, t, v)), null !== u) {
              if (void 0 !== (s = F.longerAlt)) {
                var W = P[s],
                    j = W.pattern;
                !0 === W.isCustom ? a = null !== (E = j.exec(y, v, R, S)) ? E[0] : E : (this.updateLastIndex(j, v), a = this.match(j, t, v)), a && a.length > u.length && (u = a, F = W);
              }
            ...
            for (var X = v, z = N, q = O, $ = !1; !$ && v < T;) {
              for (y.charCodeAt(v), t = this.chopInput(t, 1), v++, o = 0; o < k; o++) {
                var Z,
                    Q = P[o];
                K = Q.pattern;
                if (!1 !== (Z = Q["short"]) ? y.charCodeAt(v) === Z && ($ = !0) : !0 === Q.isCustom ? $ = null !== K.exec(y, v, R, S) : (this.updateLastIndex(K, v), $ = null !== K.exec(t)), !0 === $) break;
              }
            }

            f = v - X, d = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(y, X, f, z, q), A.push({
              offset: X,
              line: z,
              column: q,
              length: f,
        ...
        return this.hasCustom || (R.length = g), {
          tokens: R,
          groups: S,
          errors: A
        };
        ...
        var s, u;
        void 0 !== e && (u = (s = n === a - 1) ? -1 : 0, 1 === r && !0 === s || (t.endLine = i + u, t.endColumn = o - 1 - u));
    ...
    var p = function (t) {
      ...
      return i(e, t), e.prototype.collectNamedDSLMethod = function (t, e, n) {
        if (!o.isUndefined(t.name)) {
          var r = void 0;
          if (t instanceof u.Option || t instanceof u.Repetition || t instanceof u.RepetitionMandatory || t instanceof u.Alternation) r = new e({
            definition: t.definition,
            idx: t.idx
          });else {
            if (!(t instanceof u.RepetitionMandatoryWithSeparator || t instanceof u.RepetitionWithSeparator)) throw Error("non exhaustive match");
            r = new e({
              definition: t.definition,
              idx: t.idx,
    ...
    e.NamedDSLMethodsCollectorVisitor = p, e.analyzeCst = function (t, e) {
      var n = {
        dictDef: new a.HashTable(),
        allRuleNames: []
      };
      return o.forEach(t, function (t) {
        ...
        var i = new p(r);
        t.accept(i), o.forEach(i.result, function (e) {
          e.def, e.key;
          var r = e.name;
    ...
    var r, i, o;
    "undefined" != typeof self && self, i = [], void 0 === (o = "function" == typeof (r = function r() {
      function t() {}
      ...
      t.prototype.saveState = function () {
        ...
        switch (this.popChar()) {
          ...
          case "{":
            ...
            switch (this.popChar()) {
              ...
              case ",":
                var r;
                this.isDigit() ? (r = this.integerIncludingZero(), e = {
                  atLeast: n,
                  atMost: r
                }) : e = {
                  atLeast: n,
        ...
        if (!0 !== t || void 0 !== e) return u(e), "?" === this.peekChar(0) ? (this.consumeChar("?"), e.greedy = !1) : e.greedy = !0, e.type = "Quantifier", e;
        ...
        return void 0 === t && this.isPatternCharacter() && (t = this.patternCharacter()), u(t), this.isQuantifier() && (t.quantifier = this.quantifier()), t;
      ...
      return h.prototype.visitChildren = function (t) {
        for (var e in t) {
          var n = t[e];
          t.hasOwnProperty(e) && (void 0 !== n.type ? this.visit(n) : Array.isArray(n) && n.forEach(function (t) {
            this.visit(t);
          }, this));
        }
    ...
    Object.defineProperty(e, "__esModule", {
      ...
      buildUnexpectedCharactersMessage: function buildUnexpectedCharactersMessage(t, e, n, r, i) {
      ...
      switch (t.type) {
        case r.AT_LEAST_ONE:
          return function (t, e, n) {
            return M(O, new a.RepetitionMandatory({
              definition: []
            }), t, e, n);
          }(t, n, i);
        ...
        case r.TERMINAL:
          return function (t, n) {
            ...
            if (!s) throw Error("Terminal Token name: <" + o + "> not found in rule: <" + n + ">  \n\tSee: https://sap.github.io/chevrotain/docs/guide/resolving_grammar_errors.html#TERMINAL_NAME_NOT_FOUND\n\tFor Further details.");
            return new a.Terminal({
              terminalType: s,
              idx: i
            });
          }(t, i);
    ...
    }, e.buildProdGast = C, e.getDirectlyContainedRanges = D;
    var w = /\/\/.*/g,
        U = /\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\//g,
    ...
    e.removeComments = K, e.removeStringLiterals = j, e.createRanges = V, e.createTerminalRanges = Y, e.createRefsRanges = H, e.createAtLeastOneRanges = X, e.createAtLeastOneSepRanges = z, e.createManyRanges = q, e.createManySepRanges = $, e.createOptionRanges = Z, e.createOrRanges = Q;
    var J = o.partial(ot, "{", "}"),
        tt = o.partial(ot, "(", ")");
    ...
    var p = function () {
      ...
      return t.prototype.initRecoverable = function (t) {
        ...
        for (var a = this, s = this.findReSyncTokenType(), u = this.exportLexerState(), c = [], p = !1, l = this.LA(1), h = this.LA(1), f = function f() {
          var t = a.LA(0),
        ...
        return i.isEmpty(this.LAST_EXPLICIT_RULE_STACK) || (n = i.map(this.LAST_EXPLICIT_RULE_STACK, function (e) {
        ...
        var t = this;
        return i.isEmpty(this.LAST_EXPLICIT_RULE_STACK) ? i.map(this.RULE_STACK, function (e) {
    ...
    function l(t, e, n, i, o, a) {
      ...
      var p = u.token,
          l = u.occurrence,
          h = u.isEndOfRule;
      1 === this.RULE_STACK.length && h && void 0 === p && (p = r.EOF, l = 1), this.shouldInRepetitionRecoveryBeTried(p, l) && this.tryInRepetitionRecovery(t, e, n, p);
    }
    ...
    function f(t) {
      ...
      return {
        errors: u.map(e, function (t) {
          return {
            message: "Token Type: ->" + a.tokenName(t) + "<- static 'PATTERN' can only be a RegExp, a Function matching the {CustomPatternMatcherFunc} type or an Object matching the {ICustomPattern} interface.",
    ...
    e.DEFAULT_MODE = "defaultMode", e.MODES = "modes", e.SUPPORT_STICKY = "boolean" == typeof new RegExp("(?:)").sticky, e.disableSticky = function () {
      ...
      var r = u.reject(t, function (t) {
        ...
        if (u.isRegExp(e)) {
          var r = e.source;
          return 1 === r.length && "^" !== r && "$" !== r && "." !== r ? r : 2 !== r.length || "\\" !== r[0] || u.contains(["d", "D", "s", "S", "t", "r", "n", "t", "0", "c", "b", "B", "f", "v", "w", "W"], r[1]) ? n.useSticky ? O(e) : N(e) : r[1];
        }

        if (u.isFunction(e)) return i = !0, {
          exec: e
        };
      ...
      var A = !0,
          k = [];
      return n.safeMode || (k = u.reduce(r, function (t, e, r) {
      ...
      var i = f(r.valid),
          o = i.valid;
      return n = (n = (n = (n = (n = n.concat(i.errors)).concat(function (t) {
        var e = [],
    ...
    }, e.findMissingPatterns = h, e.findInvalidPatterns = f;
    var d = /[^\\][\$]/;
    ...
    function g(t) {
      ...
      return u.map(r, function (t) {
        ...
        return {
          message: "The same RegExp pattern ->" + u.first(t).PATTERN + "<-has been used in all of the following Token Types: " + e.join(", ") + " <-",
    ...
    function R(t, e) {
      ...
      return u.map(n, function (t) {
        return {
          message: "Token Type: ->" + a.tokenName(t) + "<- static 'PUSH_MODE' value cannot refer to a Lexer Mode ->" + t.PUSH_MODE + "<-which does not exist",
    ...
    function A(t) {
      var e = [],
        ...
        var r,
            i = e.PATTERN;
        return i === s.Lexer.NA ? t : (u.isString(i) ? t.push({
          str: i,
          idx: n,
          tokenType: e
        }) : u.isRegExp(i) && (r = i, void 0 === u.find([".", "\\", "[", "]", "|", "^", "$", "(", ")", "?", "*", "+", "{"], function (t) {
    ...
    function L(t, e) {
      ...
      if (S(t)) return {
        issue: s.LexerDefinitionErrorType.CUSTOM_LINE_BREAK
      };
      throw Error("non exhaustive match");
    }
    ...
    function k(t, e) {
      ...
      if (e.issue === s.LexerDefinitionErrorType.CUSTOM_LINE_BREAK) return "Warning: A Custom Token Pattern should specify the <line_breaks> option.\n\tThe problem is in the <" + t.name + "> Token Type\n\tFor details See: https://sap.github.io/chevrotain/docs/guide/resolving_lexer_errors.html#CUSTOM_LINE_BREAK";
      throw Error("non exhaustive match");
    }
    ...
    e.findStartOfInputAnchor = T, e.findUnsupportedFlags = v, e.findDuplicatePatterns = g, e.findInvalidGroupType = _, e.findModesThatDoNotExist = R, e.findUnreachablePatterns = A, e.addStartOfInput = N, e.addStickyFlag = O, e.performRuntimeChecks = function (t, n, r) {
      var i = [];
      return u.has(t, e.DEFAULT_MODE) || i.push({
      ...
      }), u.has(t, e.MODES) && u.has(t, e.DEFAULT_MODE) && !u.has(t.modes, t.defaultMode) && i.push({
      ...
      }), u.has(t, e.MODES) && u.forEach(t.modes, function (t, e) {
        u.forEach(t, function (t, n) {
          u.isUndefined(t) && i.push({
      ...
      var r = [],
        ...
        return t[l] === s.Lexer.NA;
          ...
          p = P(n);
      return e && u.forEach(a, function (t) {
        var e = L(t, p);
    ...
    }, e.isCustomPattern = S, e.isShortPattern = I, e.LineTerminatorOptimizedTester = {
      ...
      switch (t.type) {
        ...
        case "Alternative":
          for (var e = [], n = t.value, r = 0; r < n.length; r++) {
            ...
            if (!a.contains(["GroupBackReference", "Lookahead", "NegativeLookahead", "StartAnchor", "EndAnchor", "WordBoundary", "NonWordBoundary"], i.type)) {
              var o = i;
              ...
              switch (o.type) {
                ...
                case "Set":
                  ...
                  a.forEach(o.value, function (t) {
                    if ("number" == typeof t) e.push(t);else for (var n = t, r = n.from; r <= n.to; r++) {
                      e.push(r);
                    }
                  });
                  break;
    ...
    function p(t) {
      ...
      return a.forEach(t, function (t) {
        ...
        n.toUpperCase() !== n ? e.push(n.toUpperCase().charCodeAt(0)) : n.toLowerCase() !== n && e.push(n.toLowerCase().charCodeAt(0));
      }), e;
    }
    ...
    function l(t, e) {
      return a.find(t.value, function (t) {
        ...
        var n = t;
        return void 0 !== a.find(e, function (t) {
    ...
    e.failedOptimizationPrefixMsg = 'Unable to use "first char" lexer optimizations:\n', e.getStartCodes = function (t, n) {
      ...
      return [];
    }, e.firstChar = c, e.applyIgnoreCase = p;
    ...
    var r = n(12),
      ...
      return t.prototype.initLooksAhead = function (t) {
        ...
        if (void 0 === o) {
          ...
          return o = r.buildLookaheadFuncForOptionalProd(e, s, n, this.dynamicTokensEnabled, i, this.lookAheadBuilderForOptional), this.setLaFuncCache(t, o), o;
        }
    ...
    var r = n(16),
      ...
      return t.prototype.initTreeBuilder = function (t) {
        ...
        this.LAST_EXPLICIT_RULE_STACK.push(this.RULE_STACK.length - 1), this.CST_STACK.push({
          name: t,
          children: {}
        });
        ...
        if (i.isUndefined(this.baseCstVisitorConstructor)) {
          var t = o.createBaseSemanticVisitorConstructor(this.className, this.allRuleNames);
        ...
        if (i.isUndefined(this.baseCstVisitorWithDefaultsConstructor)) {
          var t = o.createBaseVisitorConstructorWithDefaults(this.className, this.allRuleNames, this.getBaseCstVisitorConstructor());
        ...
        return void 0 !== t.NAME ? (i = t.NAME, this.nestedRuleInvocationStateUpdate(i, s), {
          shortName: s,
          nestedName: i
        }) : void 0;
    ...
    function s(t, e) {
      for (var n = i.keys(t), r = n.length, o = 0; o < r; o++) {
        for (var a = t[n[o]], s = a.length, u = 0; u < s; u++) {
          var c = a[u];
          void 0 === c.tokenTypeIdx && (void 0 !== c.fullName ? this[c.fullName](c.children, e) : this[c.name](c.children, e));
        }
      }
    }
    ...
    e.defaultVisit = s, e.createBaseSemanticVisitorConstructor = function (t, e) {
      ...
      return o.defineNameProp(n, t + "BaseSemantics"), (n.prototype = {
      ...
      return i.forEach(e, function (t) {
        a[t] = s;
      }), (r.prototype = a).constructor = r, r;
    }, function (t) {
      t[t.REDUNDANT_METHOD = 0] = "REDUNDANT_METHOD", t[t.MISSING_METHOD = 1] = "MISSING_METHOD";
    }(r = e.CstVisitorDefinitionError || (e.CstVisitorDefinitionError = {})), e.validateVisitor = u, e.validateMissingCstMethods = c;
    ...
    function l(t, e) {
      ...
      for (var s in t) {
        a.validTermsPattern.test(s) && i.isFunction(t[s]) && !i.contains(p, s) && !i.contains(e, s) && n.push({
          msg: "Redundant visitor method: <" + s + "> on " + o.functionName(t.constructor) + " CST Visitor\nThere is no Grammar Rule corresponding to this method's name.\nFor utility methods on visitor classes use methods names that do not match /" + a.validTermsPattern.source + "/.",
    ...
    var r = n(0),
      ...
      return t.prototype.CONSUME = function (t, e) {
        ...
        if (r = r.concat(u.validateRuleIsOverridden(t, this.definedRulesNames, this.className)), this.definitionErrors.push.apply(this.definitionErrors, r), !this.serializedGrammar) {
    ...
    var r = n(0),
      ...
      return t.prototype.initRecognizerEngine = function (t, e) {
        ...
        var a,
            ...
            p = this.ruleShortNameIdx << i.BITS_FOR_METHOD_IDX + i.BITS_FOR_OCCURRENCE_IDX;
        this.ruleShortNameIdx++, this.shortRuleNameToFull.put(p, t), this.fullRuleNameToShort.put(t, p);
        return (a = function a(n, r) {
            ...
            try {
              ...
              if (o.isRecognitionException(t)) {
                if (r) {
                  ...
                  if (this.isInCurrentRuleReSyncSet(a)) return t.resyncedTokens = this.reSyncTo(a), this.outputCst ? ((i = this.CST_STACK[this.CST_STACK.length - 1]).recoveredNode = !0, i) : c();
                  throw this.outputCst && ((i = this.CST_STACK[this.CST_STACK.length - 1]).recoveredNode = !0, t.partialCstResult = i), t;
                }
        ...
        if (!0 !== c.call(this)) throw this.raiseEarlyExitException(t, a.PROD_TYPE.REPETITION_MANDATORY, e.ERR_MSG);

        for (var l = this.doSingleRepetition(r); !0 === c.call(this) && !0 === l;) {
          l = this.doSingleRepetition(r);
        }

        this.attemptInRepetitionRecovery(this.atLeastOneInternal, [t, e], c, i.AT_LEAST_ONE_IDX, t, s.NextTerminalAfterAtLeastOneWalker);
        ...
        var r = this,
            o = e.DEF,
            u = e.SEP;
        if (!0 !== this.getLookaheadFuncForAtLeastOneSep(n, t).call(this)) throw this.raiseEarlyExitException(t, a.PROD_TYPE.REPETITION_MANDATORY_WITH_SEPARATOR, e.ERR_MSG);
        o.call(this);
        ...
        this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal, [t, u, c, o, s.NextTerminalAfterAtLeastOneSepWalker], c, i.AT_LEAST_ONE_SEP_IDX, t, s.NextTerminalAfterAtLeastOneSepWalker);
        ...
        this.attemptInRepetitionRecovery(this.manyInternal, [t, e], u, i.MANY_IDX, t, s.NextTerminalAfterManyWalker);
        ...
        try {
          ...
          return r = t.call(this, e, i), this.cstPostNonTerminal(r, void 0 !== n && void 0 !== n.LABEL ? n.LABEL : t.ruleName), r;
        } catch (e) {
        ...
        try {
          ...
          if (!0 !== this.tokenMatcher(i, t)) {
            var a = void 0,
                s = this.LA(0);
            throw a = void 0 !== n && n.ERR_MSG ? n.ERR_MSG : this.errorMessageProvider.buildMismatchTokenMessage({
              expected: t,
              actual: i,
              previous: s,
              ruleName: this.getCurrRuleFullName()
    ...
    var r = n(6),
      ...
      return t.prototype.initErrorHandler = function (t) {
        ...
        for (var i = this.getCurrRuleFullName(), a = this.getGAstProductions().get(i), s = o.getLookaheadPathsForOptionalProd(t, a, e, this.maxLookahead)[0], u = [], c = 1; c < this.maxLookahead; c++) {
          u.push(this.LA(c));
        }
        ...
        for (var n = this.getCurrRuleFullName(), i = this.getGAstProductions().get(n), a = o.getLookaheadPathsForOr(t, i, this.maxLookahead), s = [], u = 1; u <= this.maxLookahead; u++) {
          s.push(this.LA(u));
        }
    ...
    function f(t, e) {
      var n = y(e, "{") + a;
      return t.name && (n += y(e + 1, 'NAME: "' + t.name + '",') + a), n += y(e + 1, "ALT: function() {") + a, n += m(t.definition, e + 1), n += y(e + 1, "}") + a, n += y(e, "}");
    }

    function d(t, e, n) {
      var r = y(n, "$." + (t + e.idx) + "(");
      return e.name || e.separator ? (r += "{" + a, e.name && (r += y(n + 1, 'NAME: "' + e.name + '"') + "," + a), e.separator && (r += y(n + 1, "SEP: this.tokensMap." + i.tokenName(e.separator)) + "," + a), r += "DEF: " + E(e.definition, n + 2) + a, r += y(n, "}") + a) : r += E(e.definition, n + 1), r += y(n, ")") + a;
    }
