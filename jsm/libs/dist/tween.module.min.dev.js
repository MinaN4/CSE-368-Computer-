...
TWEEN.Group = _Group, TWEEN._nextId = 0, TWEEN.nextId = function () {
  ...
  update: function update(t) {
    ...
    for (n in !1 === this._onStartCallbackFired && (null !== this._onStartCallback && this._onStartCallback(this._object), this._onStartCallbackFired = !0), e = (t - this._startTime) / this._duration, e = 0 === this._duration || 1 < e ? 1 : e, i = this._easingFunction(e), this._valuesEnd) {
  ...
  CatmullRom: function CatmullRom(t, n) {
    var e = t.length - 1,
        i = e * n,
        r = Math.floor(i),
  ...
  Utils: {
    ...
    Bernstein: function Bernstein(t, n) {
    ...
    CatmullRom: function CatmullRom(t, n, e, i, r) {
      var a = .5 * (e - t),
          s = .5 * (i - n),
          o = r * r;
  ...
  "function" == typeof define && define.amd ? define([], function () {
    return TWEEN;
  }) : "undefined" != typeof module && "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = TWEEN : void 0 !== t && (t.TWEEN = TWEEN);
}(void 0);