...
var SSAARenderPass = function SSAARenderPass(scene, camera, clearColor, clearAlpha) {
  ...
  if (_CopyShader.CopyShader === undefined) console.error("SSAARenderPass relies on CopyShader");
  ...
  this.fsQuad = new _Pass.Pass.FullScreenQuad(this.copyMaterial);
};
...
SSAARenderPass.prototype = Object.assign(Object.create(_Pass.Pass.prototype), {
  ...
  render: function render(renderer, writeBuffer, readBuffer) {
    if (!this.sampleRenderTarget) {
      this.sampleRenderTarget = new _threeModule.WebGLRenderTarget(readBuffer.width, readBuffer.height, {
