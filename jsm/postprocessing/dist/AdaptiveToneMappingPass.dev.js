...
var AdaptiveToneMappingPass = function AdaptiveToneMappingPass(adaptive, resolution) {
  ...
  if (_CopyShader.CopyShader === undefined) console.error("AdaptiveToneMappingPass relies on CopyShader");
  ...
  if (_LuminosityShader.LuminosityShader === undefined) console.error("AdaptiveToneMappingPass relies on LuminosityShader");
  this.materialLuminance = new _threeModule.ShaderMaterial({
    uniforms: _threeModule.UniformsUtils.clone(_LuminosityShader.LuminosityShader.uniforms),
  ...
  this.materialAdaptiveLum = new _threeModule.ShaderMaterial({
    uniforms: _threeModule.UniformsUtils.clone(this.adaptLuminanceShader.uniforms),
    vertexShader: this.adaptLuminanceShader.vertexShader,
    fragmentShader: this.adaptLuminanceShader.fragmentShader,
    defines: Object.assign({}, this.adaptLuminanceShader.defines),
    blending: _threeModule.NoBlending
  });
  if (_ToneMapShader.ToneMapShader === undefined) console.error("AdaptiveToneMappingPass relies on ToneMapShader");
  this.materialToneMap = new _threeModule.ShaderMaterial({
    uniforms: _threeModule.UniformsUtils.clone(_ToneMapShader.ToneMapShader.uniforms),
...
AdaptiveToneMappingPass.prototype = Object.assign(Object.create(_Pass.Pass.prototype), {
  ...
  reset: function reset() {
    ...
    this.luminanceRT = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, pars);
    this.luminanceRT.texture.name = "AdaptiveToneMappingPass.l";
    this.luminanceRT.texture.generateMipmaps = false;
    this.previousLuminanceRT = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, pars);
    ...
    pars.minFilter = _threeModule.LinearMipmapLinearFilter;
    pars.generateMipmaps = true;
    this.currentLuminanceRT = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, pars);
    ...
    this.fsQuad.material = new _threeModule.MeshBasicMaterial({
      color: 0x777777
    });
