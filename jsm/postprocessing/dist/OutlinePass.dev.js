...
var OutlinePass = function OutlinePass(resolution, scene, camera, selectedObjects) {
  ...
  this.visibleEdgeColor = new _threeModule.Color(1, 1, 1);
  this.hiddenEdgeColor = new _threeModule.Color(0.1, 0.04, 0.02);
  this.edgeGlow = 0.0;
  ...
  this.maskBufferMaterial = new _threeModule.MeshBasicMaterial({
    color: 0xffffff
  });
  this.maskBufferMaterial.side = _threeModule.DoubleSide;
  this.renderTargetMaskBuffer = new _threeModule.WebGLRenderTarget(this.resolution.x, this.resolution.y, pars);
  this.renderTargetMaskBuffer.texture.name = "OutlinePass.mask";
  this.renderTargetMaskBuffer.texture.generateMipmaps = false;
  this.depthMaterial = new _threeModule.MeshDepthMaterial();
  this.depthMaterial.side = _threeModule.DoubleSide;
  ...
  this.prepareMaskMaterial.side = _threeModule.DoubleSide;
  this.prepareMaskMaterial.fragmentShader = replaceDepthToViewZ(this.prepareMaskMaterial.fragmentShader, this.renderCamera);
  this.renderTargetDepthBuffer = new _threeModule.WebGLRenderTarget(this.resolution.x, this.resolution.y, pars);
  this.renderTargetDepthBuffer.texture.name = "OutlinePass.depth";
  this.renderTargetDepthBuffer.texture.generateMipmaps = false;
  this.renderTargetMaskDownSampleBuffer = new _threeModule.WebGLRenderTarget(resx, resy, pars);
  this.renderTargetMaskDownSampleBuffer.texture.name = "OutlinePass.depthDownSample";
  this.renderTargetMaskDownSampleBuffer.texture.generateMipmaps = false;
  this.renderTargetBlurBuffer1 = new _threeModule.WebGLRenderTarget(resx, resy, pars);
  this.renderTargetBlurBuffer1.texture.name = "OutlinePass.blur1";
  this.renderTargetBlurBuffer1.texture.generateMipmaps = false;
  this.renderTargetBlurBuffer2 = new _threeModule.WebGLRenderTarget(Math.round(resx / 2), Math.round(resy / 2), pars);
  this.renderTargetBlurBuffer2.texture.name = "OutlinePass.blur2";
  this.renderTargetBlurBuffer2.texture.generateMipmaps = false;
  this.edgeDetectionMaterial = this.getEdgeDetectionMaterial();
  this.renderTargetEdgeBuffer1 = new _threeModule.WebGLRenderTarget(resx, resy, pars);
  this.renderTargetEdgeBuffer1.texture.name = "OutlinePass.edge1";
  this.renderTargetEdgeBuffer1.texture.generateMipmaps = false;
  this.renderTargetEdgeBuffer2 = new _threeModule.WebGLRenderTarget(Math.round(resx / 2), Math.round(resy / 2), pars);
  this.renderTargetEdgeBuffer2.texture.name = "OutlinePass.edge2";
  this.renderTargetEdgeBuffer2.texture.generateMipmaps = false;
  var MAX_EDGE_THICKNESS = 4;
  var MAX_EDGE_GLOW = 4;
  this.separableBlurMaterial1 = this.getSeperableBlurMaterial(MAX_EDGE_THICKNESS);
  this.separableBlurMaterial1.uniforms["texSize"].value = new _threeModule.Vector2(resx, resy);
  this.separableBlurMaterial1.uniforms["kernelRadius"].value = 1;
  this.separableBlurMaterial2 = this.getSeperableBlurMaterial(MAX_EDGE_GLOW);
  this.separableBlurMaterial2.uniforms["texSize"].value = new _threeModule.Vector2(Math.round(resx / 2), Math.round(resy / 2));
  ...
  if (_CopyShader.CopyShader === undefined) console.error("OutlinePass relies on CopyShader");
  ...
  this.tempPulseColor1 = new _threeModule.Color();
  this.tempPulseColor2 = new _threeModule.Color();
  this.textureMatrix = new _threeModule.Matrix4();
...
OutlinePass.prototype = Object.assign(Object.create(_Pass.Pass.prototype), {
  ...
  setSize: function setSize(width, height) {
    ...
    this.separableBlurMaterial2.uniforms["texSize"].value = new _threeModule.Vector2(resx, resy);
  },
  ...
  render: function render(renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
    if (this.selectedObjects.length > 0) {
      ...
      this.prepareMaskMaterial.uniforms["cameraNearFar"].value = new _threeModule.Vector2(this.renderCamera.near, this.renderCamera.far);
      ...
      this.edgeDetectionMaterial.uniforms["texSize"].value = new _threeModule.Vector2(this.renderTargetMaskDownSampleBuffer.width, this.renderTargetMaskDownSampleBuffer.height);
  ...
  getEdgeDetectionMaterial: function getEdgeDetectionMaterial() {
    return new _threeModule.ShaderMaterial({
      uniforms: {
        ...
        "visibleEdgeColor": {
          value: new _threeModule.Vector3(1.0, 1.0, 1.0)
        },
        "hiddenEdgeColor": {
          value: new _threeModule.Vector3(1.0, 1.0, 1.0)
        }
...
OutlinePass.BlurDirectionX = new _threeModule.Vector2(1.0, 0.0);
OutlinePass.BlurDirectionY = new _threeModule.Vector2(0.0, 1.0);