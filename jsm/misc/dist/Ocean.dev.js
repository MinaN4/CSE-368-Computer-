...
var _OceanShaders = require("../shaders/OceanShaders.js");
...
var Ocean = function Ocean(renderer, camera, scene, options) {
  ...
  this.oceanCamera = new _threeModule.OrthographicCamera(); //camera.clone();

  this.oceanCamera.position.z = 1;
  this.renderer = renderer;
  this.renderer.clearColor(0xffffff);
  this.scene = new _threeModule.Scene(); // Assign optional parameters as variables and object properties
  ...
  this.oceanColor = optionalParameter(options.OCEAN_COLOR, new _threeModule.Vector3(0.004, 0.016, 0.047));
  this.skyColor = optionalParameter(options.SKY_COLOR, new _threeModule.Vector3(3.2, 9.6, 12.8));
  ...
  var renderTargetType = optionalParameter(options.USE_HALF_FLOAT, false) ? _threeModule.HalfFloatType : _threeModule.FloatType;
  var LinearClampParams = {
    minFilter: _threeModule.LinearFilter,
    magFilter: _threeModule.LinearFilter,
    wrapS: _threeModule.ClampToEdgeWrapping,
    wrapT: _threeModule.ClampToEdgeWrapping,
  ...
  var NearestRepeatParams = {
    minFilter: _threeModule.NearestFilter,
    magFilter: _threeModule.NearestFilter,
    wrapS: _threeModule.RepeatWrapping,
    wrapT: _threeModule.RepeatWrapping,
    format: _threeModule.RGBAFormat,
    stencilBuffer: false,
    depthBuffer: false,
    premultiplyAlpha: false,
  ...
  this.initialSpectrumFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, NearestRepeatParams);
  this.spectrumFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
  this.pingPhaseFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
  this.pongPhaseFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
  this.pingTransformFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
  this.pongTransformFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
  this.displacementMapFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, LinearClampParams);
  this.normalMapFramebuffer = new _threeModule.WebGLRenderTarget(this.resolution, this.resolution, LinearClampParams); // Define shaders and constant uniforms
  ////////////////////////////////////////
  // 0 - The vertex shader used in all of the simulation steps

  var fullscreeenVertexShader = _OceanShaders.OceanShaders["ocean_sim_vertex"]; // 1 - Horizontal wave vertices used for FFT

  var oceanHorizontalShader = _OceanShaders.OceanShaders["ocean_subtransform"];

  var oceanHorizontalUniforms = _threeModule.UniformsUtils.clone(oceanHorizontalShader.uniforms);

  this.materialOceanHorizontal = new _threeModule.ShaderMaterial({
  ...
  var oceanVerticalShader = _OceanShaders.OceanShaders["ocean_subtransform"];

  var oceanVerticalUniforms = _threeModule.UniformsUtils.clone(oceanVerticalShader.uniforms);

  this.materialOceanVertical = new _threeModule.ShaderMaterial({
  ...
  var initialSpectrumShader = _OceanShaders.OceanShaders["ocean_initial_spectrum"];

  var initialSpectrumUniforms = _threeModule.UniformsUtils.clone(initialSpectrumShader.uniforms);

  this.materialInitialSpectrum = new _threeModule.ShaderMaterial({
  ...
  var phaseShader = _OceanShaders.OceanShaders["ocean_phase"];

  var phaseUniforms = _threeModule.UniformsUtils.clone(phaseShader.uniforms);

  this.materialPhase = new _threeModule.ShaderMaterial({
  ...
  var spectrumShader = _OceanShaders.OceanShaders["ocean_spectrum"];

  var spectrumUniforms = _threeModule.UniformsUtils.clone(spectrumShader.uniforms);

  this.materialSpectrum = new _threeModule.ShaderMaterial({
  ...
  var normalShader = _OceanShaders.OceanShaders["ocean_normals"];

  var normalUniforms = _threeModule.UniformsUtils.clone(normalShader.uniforms);

  this.materialNormal = new _threeModule.ShaderMaterial({
  ...
  var oceanShader = _OceanShaders.OceanShaders["ocean_main"];

  var oceanUniforms = _threeModule.UniformsUtils.clone(oceanShader.uniforms);

  this.materialOcean = new _threeModule.ShaderMaterial({
  ...
  this.materialOcean.uniforms.u_sunDirection = {
    value: new _threeModule.Vector3(this.sunDirectionX, this.sunDirectionY, this.sunDirectionZ)
  };
  ...
  this.screenQuad = new _threeModule.Mesh(new _threeModule.PlaneBufferGeometry(2, 2));
...
Ocean.prototype.generateMesh = function () {
  var geometry = new _threeModule.PlaneBufferGeometry(this.geometrySize, this.geometrySize, this.geometryResolution, this.geometryResolution);
  geometry.rotateX(-Math.PI / 2);
  this.oceanMesh = new _threeModule.Mesh(geometry, this.materialOcean);
};
...
Ocean.prototype.generateSeedPhaseTexture = function () {
  ...
  this.pingPhaseTexture = new _threeModule.DataTexture(phaseArray, this.resolution, this.resolution, _threeModule.RGBAFormat);
  this.pingPhaseTexture.wrapS = _threeModule.ClampToEdgeWrapping;
  this.pingPhaseTexture.wrapT = _threeModule.ClampToEdgeWrapping;
  this.pingPhaseTexture.type = _threeModule.FloatType;
};
