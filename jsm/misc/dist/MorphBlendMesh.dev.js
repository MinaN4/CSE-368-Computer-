...
MorphBlendMesh.prototype = Object.assign(Object.create(_threeModule.Mesh.prototype), {
  ...
  update: function update(delta) {
    for (var i = 0, il = this.animationsList.length; i < il; i++) {
      ...
      var keyframe = animation.start + _threeModule.Math.clamp(Math.floor(animation.time / frameTime), 0, animation.length - 1);
