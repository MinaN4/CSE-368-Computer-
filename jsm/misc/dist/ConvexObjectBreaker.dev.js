...
var ConvexObjectBreaker = function ConvexObjectBreaker(minSizeForBreak, smallDelta) {
  ...
  this.tempLine1 = new _threeModule.Line3();
  this.tempPlane1 = new _threeModule.Plane();
  this.tempPlane2 = new _threeModule.Plane();
  this.tempPlane_Cut = new _threeModule.Plane();
  this.tempCM1 = new _threeModule.Vector3();
  this.tempCM2 = new _threeModule.Vector3();
  this.tempVector3 = new _threeModule.Vector3();
  this.tempVector3_2 = new _threeModule.Vector3();
  this.tempVector3_3 = new _threeModule.Vector3();
  this.tempVector3_P0 = new _threeModule.Vector3();
  this.tempVector3_P1 = new _threeModule.Vector3();
  this.tempVector3_P2 = new _threeModule.Vector3();
  this.tempVector3_N0 = new _threeModule.Vector3();
  this.tempVector3_N1 = new _threeModule.Vector3();
  this.tempVector3_AB = new _threeModule.Vector3();
  this.tempVector3_CB = new _threeModule.Vector3();
...
ConvexObjectBreaker.prototype = {
  ...
  cutByPlane: function cutByPlane(object, plane, output) {
    ...
    for (var i = 0; i < numFaces; i++) {
      ...
      for (var segment = 0; segment < 3; segment++) {
        ...
        if (mark0 === 1 && mark1 === 2 || mark0 === 2 && mark1 === 1) {
          ...
          var intersection = new _threeModule.Vector3();
    ...
    if (numPoints1 > 4) {
      object1 = new _threeModule.Mesh(new _ConvexGeometry.ConvexBufferGeometry(points1), object.material);
    ...
    if (numPoints2 > 4) {
      object2 = new _threeModule.Mesh(new _ConvexGeometry.ConvexBufferGeometry(points2), object.material);
