...
var _VolumeSlice = require("../misc/VolumeSlice.js");
...
var Volume = function Volume(xLength, yLength, zLength, type, arrayBuffer) {
  ...
  this.matrix = new _threeModule.Matrix3();
...
Volume.prototype = {
  ...
  extractPerpendicularPlane: function extractPerpendicularPlane(axis, RASIndex) {
    var iLength,
        jLength,
        sliceAccess,
        planeMatrix = new _threeModule.Matrix4().identity(),
        volume = this,
        planeWidth,
        planeHeight,
        firstSpacing,
        ...
        positionOffset,
        IJKIndex;
    var axisInIJK = new _threeModule.Vector3(),
        firstDirection = new _threeModule.Vector3(),
        secondDirection = new _threeModule.Vector3();
    var dimensions = new _threeModule.Vector3(this.xLength, this.yLength, this.zLength);
    ...
    switch (axis) {
      case 'x':
        ...
        IJKIndex = new _threeModule.Vector3(RASIndex, 0, 0);
        planeMatrix.multiply(new _threeModule.Matrix4().makeRotationY(Math.PI / 2));
        positionOffset = (volume.RASDimensions[0] - 1) / 2;
        planeMatrix.setPosition(new _threeModule.Vector3(RASIndex - positionOffset, 0, 0));
        break;
      ...
      case 'y':
        ...
        IJKIndex = new _threeModule.Vector3(0, RASIndex, 0);
        planeMatrix.multiply(new _threeModule.Matrix4().makeRotationX(-Math.PI / 2));
        positionOffset = (volume.RASDimensions[1] - 1) / 2;
        planeMatrix.setPosition(new _threeModule.Vector3(0, RASIndex - positionOffset, 0));
        break;
      ...
      default:
        ...
        firstSpacing = this.spacing[0];
        secondSpacing = this.spacing[1];
        IJKIndex = new _threeModule.Vector3(0, 0, RASIndex);
        positionOffset = (volume.RASDimensions[2] - 1) / 2;
        planeMatrix.setPosition(new _threeModule.Vector3(0, 0, RASIndex - positionOffset));
        break;
    }
    ...
    var base = [new _threeModule.Vector3(1, 0, 0), new _threeModule.Vector3(0, 1, 0), new _threeModule.Vector3(0, 0, 1)];
