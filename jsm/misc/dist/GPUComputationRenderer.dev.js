...
var GPUComputationRenderer = function GPUComputationRenderer(sizeX, sizeY, renderer) {
  ...
  var camera = new _threeModule.Camera();
  camera.position.z = 1;
  ...
  var mesh = new _threeModule.Mesh(new _threeModule.PlaneBufferGeometry(2, 2), passThruShader);
  scene.add(mesh);
  ...
  this.init = function () {
    if (!renderer.extensions.get("OES_texture_float") && !renderer.capabilities.isWebGL2) {
  ...
  this.createRenderTarget = function (sizeXTexture, sizeYTexture, wrapS, wrapT, minFilter, magFilter) {
    ...
    wrapS = wrapS || _threeModule.ClampToEdgeWrapping;
    wrapT = wrapT || _threeModule.ClampToEdgeWrapping;
    minFilter = minFilter || _threeModule.NearestFilter;
    magFilter = magFilter || _threeModule.NearestFilter;
    var renderTarget = new _threeModule.WebGLRenderTarget(sizeXTexture, sizeYTexture, {
      wrapS: wrapS,
      wrapT: wrapT,
      minFilter: minFilter,
      magFilter: magFilter,
      format: _threeModule.RGBAFormat,
      type: /(iPad|iPhone|iPod)/g.test(navigator.userAgent) ? _threeModule.HalfFloatType : _threeModule.FloatType,
      stencilBuffer: false,
      depthBuffer: false
    });
    return renderTarget;
  ...
  this.createTexture = function () {
    ...
    var texture = new _threeModule.DataTexture(a, sizeX, sizeY, _threeModule.RGBAFormat, _threeModule.FloatType);
