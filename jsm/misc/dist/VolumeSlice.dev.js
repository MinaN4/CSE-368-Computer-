...
var VolumeSlice = function VolumeSlice(volume, index, axis) {
  ...
  this.updateGeometry();
  var canvasMap = new _threeModule.Texture(this.canvas);
  canvasMap.minFilter = _threeModule.LinearFilter;
  canvasMap.wrapS = canvasMap.wrapT = _threeModule.ClampToEdgeWrapping;
  ...
  this.mesh = new _threeModule.Mesh(this.geometry, material);
...
VolumeSlice.prototype = {
  ...
  updateGeometry: function updateGeometry() {
    ...
    this.geometry = new _threeModule.PlaneBufferGeometry(extracted.planeWidth, extracted.planeHeight);
