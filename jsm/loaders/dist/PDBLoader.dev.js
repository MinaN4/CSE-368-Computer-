...
PDBLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function parse(text) {
    ...
    function buildGeometry() {
      var build = {
        geometryAtoms: new _threeModule.BufferGeometry(),
        geometryBonds: new _threeModule.BufferGeometry(),
        json: {
          atoms: atoms,
          bonds: bonds
        }
      ...
      geometryAtoms.setAttribute('position', new _threeModule.Float32BufferAttribute(verticesAtoms, 3));
      geometryAtoms.setAttribute('color', new _threeModule.Float32BufferAttribute(colorsAtoms, 3));
      geometryBonds.setAttribute('position', new _threeModule.Float32BufferAttribute(verticesBonds, 3));
      return build;
    }
