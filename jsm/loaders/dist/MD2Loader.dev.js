...
MD2Loader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function () {
    ...
    return function (buffer) {
      ...
      var geometry = new _threeModule.BufferGeometry(); // uvs
      ...
      var translation = new _threeModule.Vector3();
      ...
      geometry.setAttribute('uv', new _threeModule.Float32BufferAttribute(uvs, 2)); // animation
      ...
      for (var i = 0, l = frames.length; i < l; i++) {
        ...
        if (frame.vertices.length > 0) {
          ...
          var positionAttribute = new _threeModule.Float32BufferAttribute(positions, 3);
        ...
        if (frame.normals.length > 0) {
          ...
          var normalAttribute = new _threeModule.Float32BufferAttribute(normals, 3);
      ...
      geometry.animations = _threeModule.AnimationClip.CreateClipsFromMorphTargetSequences(frames, 10);
