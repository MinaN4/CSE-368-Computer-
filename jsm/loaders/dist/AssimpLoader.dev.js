...
AssimpLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function parse(buffer, path) {
    ...
    Virtulous.KeyFrame = function (time, matrix) {
      ...
      this.position = new _threeModule.Vector3();
      this.quaternion = new _threeModule.Quaternion();
      this.scale = new _threeModule.Vector3(1, 1, 1);
    ...
    Virtulous.KeyFrame.tempAniPos = new _threeModule.Vector3();
    Virtulous.KeyFrame.tempAniQuat = new _threeModule.Quaternion();
    Virtulous.KeyFrame.tempAniScale = new _threeModule.Vector3(1, 1, 1);
    Virtulous.KeyFrame.tempAniMatrix = new _threeModule.Matrix4();
    ...
    function cloneTreeToBones(root, scene) {
      var rootBone = new _threeModule.Bone();
    ...
    function aiMesh() {
      ...
      this.hookupSkeletons = function (scene) {
        ...
        var skeleton = new _threeModule.Skeleton(allBones, offsetMatrix);
        this.threeNode.bind(skeleton, new _threeModule.Matrix4());
      ...
      this.toTHREE = function (scene) {
        ...
        var mat;
        if (scene.mMaterials[this.mMaterialIndex]) mat = scene.mMaterials[this.mMaterialIndex].toTHREE(scene);else mat = new _threeModule.MeshLambertMaterial();
        geometry.setIndex(new _threeModule.BufferAttribute(new Uint32Array(this.mIndexArray), 1));
        geometry.setAttribute('position', new _threeModule.BufferAttribute(this.mVertexBuffer, 3));
        if (this.mNormalBuffer && this.mNormalBuffer.length > 0) geometry.setAttribute('normal', new _threeModule.BufferAttribute(this.mNormalBuffer, 3));
        if (this.mColorBuffer && this.mColorBuffer.length > 0) geometry.setAttribute('color', new _threeModule.BufferAttribute(this.mColorBuffer, 4));
        if (this.mTexCoordsBuffers[0] && this.mTexCoordsBuffers[0].length > 0) geometry.setAttribute('uv', new _threeModule.BufferAttribute(new Float32Array(this.mTexCoordsBuffers[0]), 2));
        if (this.mTexCoordsBuffers[1] && this.mTexCoordsBuffers[1].length > 0) geometry.setAttribute('uv1', new _threeModule.BufferAttribute(new Float32Array(this.mTexCoordsBuffers[1]), 2));
        if (this.mTangentBuffer && this.mTangentBuffer.length > 0) geometry.setAttribute('tangents', new _threeModule.BufferAttribute(this.mTangentBuffer, 3));
        if (this.mBitangentBuffer && this.mBitangentBuffer.length > 0) geometry.setAttribute('bitangents', new _threeModule.BufferAttribute(this.mBitangentBuffer, 3));
        ...
        if (this.mBones.length > 0) {
          ...
          geometry.setAttribute('skinWeight', new _threeModule.BufferAttribute(new Float32Array(_weights), BONESPERVERT));
          geometry.setAttribute('skinIndex', new _threeModule.BufferAttribute(new Float32Array(_bones), BONESPERVERT));
        }

        var mesh;
        if (this.mBones.length == 0) mesh = new _threeModule.Mesh(geometry, mat);

        if (this.mBones.length > 0) {
          mesh = new _threeModule.SkinnedMesh(geometry, mat);
    ...
    function aiVector3D() {
      ...
      this.toTHREE = function () {
        return new _threeModule.Vector3(this.x, this.y, this.z);
      };
    }
    ...
    function aiColor3D() {
      ...
      this.toTHREE = function () {
        return new _threeModule.Color(this.r, this.g, this.b);
      };
    }
    ...
    function aiQuaternion() {
      ...
      this.toTHREE = function () {
        return new _threeModule.Quaternion(this.x, this.y, this.z, this.w);
      };
    }
    ...
    function aiNode() {
      ...
      this.toTHREE = function (scene) {
        if (this.threeNode) return this.threeNode;
        var o = new _threeModule.Object3D();
        o.name = this.mName;
    ...
    function aiMaterialProperty() {
      ...
      this.dataAsColor = function () {
        ...
        return new _threeModule.Color(r, g, b);
      };
    ...
    function aiMaterial() {
      ...
      this.toTHREE = function () {
        var mat = new _threeModule.MeshPhongMaterial();
    ...
    function aiMatrix4() {
      ...
      this.toTHREE = function () {
        var m = new _threeModule.Matrix4();
