...
var _chevrotainModuleMin = require("../libs/chevrotain.module.min.js");
...
var VRMLLoader = function () {
  // dependency check
  if (typeof _chevrotainModuleMin.chevrotain === 'undefined') {
  ...
  VRMLLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
    ...
    parse: function parse(data, path) {
      ...
      function createTokens() {
        var createToken = _chevrotainModuleMin.chevrotain.createToken; // from http://gun.teipir.gr/VRML-amgem/spec/part1/concepts.html#SyntaxBasics
        ...
        var Comment = createToken({
          name: 'Comment',
          pattern: /#.*/,
          group: _chevrotainModuleMin.chevrotain.Lexer.SKIPPED
      ...
      function parseTree(tree) {
        ...
        var scene = new _threeModule.Scene(); // first iteration: build nodemap based on DEF statements
        ...
        for (var i = 0, l = nodes.length; i < l; i++) {
          ...
          if (object instanceof _threeModule.Object3D) scene.add(object);
        }
      ...
      function buildGroupingNode(node) {
        var object = new _threeModule.Group(); //
        ...
        for (var i = 0, l = fields.length; i < l; i++) {
          ...
          switch (fieldName) {
            ...
            case 'rotation':
              var axis = new _threeModule.Vector3(fieldValues[0], fieldValues[1], fieldValues[2]);
      ...
      function buildBackgroundNode(node) {
        ...
        if (skyColor) {
          var skyGeometry = new _threeModule.SphereBufferGeometry(radius, 32, 16);
          var skyMaterial = new _threeModule.MeshBasicMaterial({
            fog: false,
          ...
          if (skyColor.length > 3) {
            ...
            skyMaterial.vertexColors = _threeModule.VertexColors;
          } else {
            skyMaterial.color.setRGB(skyColor[0], skyColor[1], skyColor[2]);
          }

          var sky = new _threeModule.Mesh(skyGeometry, skyMaterial);
          group.add(sky);
        } // ground
        ...
        if (groundColor) {
          if (groundColor.length > 0) {
            var groundGeometry = new _threeModule.SphereBufferGeometry(radius, 32, 16, 0, 2 * Math.PI, 0.5 * Math.PI, 1.5 * Math.PI);
            var groundMaterial = new _threeModule.MeshBasicMaterial({
              fog: false,
              side: _threeModule.BackSide,
            ...
            var ground = new _threeModule.Mesh(groundGeometry, groundMaterial);
            group.add(ground);
          }
      ...
      function buildShapeNode(node) {
        ...
        if (geometry && geometry.attributes.position) {
          ...
          if (type === 'points') {
            // points
            var pointsMaterial = new _threeModule.PointsMaterial({
              color: 0xffffff
            });

            if (geometry.attributes.color !== undefined) {
              pointsMaterial.vertexColors = _threeModule.VertexColors;
            } else {
            ...
            object = new _threeModule.Points(geometry, pointsMaterial);
          } else if (type === 'line') {
            // lines
            ...
            if (geometry.attributes.color !== undefined) {
              lineMaterial.vertexColors = _threeModule.VertexColors;
            } else {
            ...
            object = new _threeModule.LineSegments(geometry, lineMaterial);
          } else {
            // consider meshes
            // check "solid" hint (it's placed in the geometry but affects the material)
            if (geometry._solid !== undefined) {
              material.side = geometry._solid ? _threeModule.FrontSide : _threeModule.DoubleSide;
            ...
            object = new _threeModule.Mesh(geometry, material);
          }
        } else {
          object = new _threeModule.Object3D(); // if the geometry field is NULL or no vertices are defined the object is not drawn
      ...
      function buildAppearanceNode(node) {
        var material = new _threeModule.MeshPhongMaterial();
        var transformData;
        var fields = node.fields;
          ...
          switch (fieldName) {
            case 'material':
              if (fieldValues[0] !== null) {
                ...
                material = new _threeModule.MeshBasicMaterial({
                  color: 0x000000
                });
              }
      ...
      function buildMaterialNode(node) {
        ...
        for (var i = 0, l = fields.length; i < l; i++) {
          ...
          switch (fieldName) {
            ...
            case 'diffuseColor':
              materialData.diffuseColor = new _threeModule.Color(fieldValues[0], fieldValues[1], fieldValues[2]);
              break;

            case 'emissiveColor':
              materialData.emissiveColor = new _threeModule.Color(fieldValues[0], fieldValues[1], fieldValues[2]);
              break;
      ...
      function buildPixelTextureNode(node) {
        var texture;
        var wrapS = _threeModule.RepeatWrapping;
        var wrapT = _threeModule.RepeatWrapping;
        var fields = node.fields;
        ...
        for (var i = 0, l = fields.length; i < l; i++) {
          ...
          switch (fieldName) {
            case 'image':
              ...
              texture = new _threeModule.DataTexture(data, width, height, useAlpha === true ? _threeModule.RGBAFormat : _threeModule.RGBFormat);
              texture.__type = textureType; // needed for material modifications

              break;

            case 'repeatS':
              if (fieldValues[0] === false) wrapS = _threeModule.ClampToEdgeWrapping;
              break;

            case 'repeatT':
              if (fieldValues[0] === false) wrapT = _threeModule.ClampToEdgeWrapping;
              break;
      ...
      function buildTextureTransformNode(node) {
        var transformData = {
          center: new _threeModule.Vector2(),
          rotation: new _threeModule.Vector2(),
          scale: new _threeModule.Vector2(),
          translation: new _threeModule.Vector2()
        };
        var fields = node.fields;
      ...
      function buildIndexedFaceSetNode(node) {
        ...
        if (coordIndex === undefined) {
          ...
          return new _threeModule.BufferGeometry(); // handle VRML files with incomplete geometry definition
        }
        ...
        if (color) {
          if (colorPerVertex === true) {
            if (colorIndex && colorIndex.length > 0) {
              ...
              colorAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new _threeModule.Float32BufferAttribute(color, 3));
            }
          } else {
            if (colorIndex && colorIndex.length > 0) {
        ...
        if (normal) {
          if (normalPerVertex === true) {
            ...
            if (normalIndex && normalIndex.length > 0) {
              ...
              normalAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new _threeModule.Float32BufferAttribute(normal, 3));
            }
          } else {
        ...
        if (texCoord) {
          ...
          if (texCoordIndex && texCoordIndex.length > 0) {
            ...
            uvAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new _threeModule.Float32BufferAttribute(texCoord, 2));
          }
        }

        var geometry = new _threeModule.BufferGeometry();
        positionAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new _threeModule.Float32BufferAttribute(coord, 3));
      ...
      function buildIndexedLineSetNode(node) {
        ...
        if (color) {
          if (colorPerVertex === true) {
            if (colorIndex.length > 0) {
              ...
              colorAttribute = toNonIndexedAttribute(expandedLineIndex, new _threeModule.Float32BufferAttribute(color, 3));
            }
          } else {
            if (colorIndex.length > 0) {
        ...
        var geometry = new _threeModule.BufferGeometry();
        var positionAttribute = toNonIndexedAttribute(expandedLineIndex, new _threeModule.Float32BufferAttribute(coord, 3));
        geometry.setAttribute('position', positionAttribute);
        if (colorAttribute) geometry.setAttribute('color', colorAttribute);
        geometry._type = 'line';
        return geometry;
      ...
      function buildPointSetNode(node) {
        ...
        var geometry = new _threeModule.BufferGeometry();
        geometry.setAttribute('position', new _threeModule.Float32BufferAttribute(coord, 3));
        if (color) geometry.setAttribute('color', new _threeModule.Float32BufferAttribute(color, 3));
        geometry._type = 'points';
        return geometry;
      }

      function buildBoxNode(node) {
        var size = new _threeModule.Vector3(2, 2, 2);
        var fields = node.fields;
        ...
        var geometry = new _threeModule.BoxBufferGeometry(size.x, size.y, size.z);
        return geometry;
      }
      ...
      function buildConeNode(node) {
        ...
        var geometry = new _threeModule.ConeBufferGeometry(radius, height, 16, 1, openEnded);
        return geometry;
      }
      ...
      function buildCylinderNode(node) {
        ...
        var geometry = new _threeModule.CylinderBufferGeometry(radius, radius, height, 16, 1);
        return geometry;
      }
      ...
      function buildSphereNode(node) {
        ...
        var geometry = new _threeModule.SphereBufferGeometry(radius, 16, 16);
        return geometry;
      } // helper functions
      ...
      function parseFieldChildren(children, owner) {
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (object instanceof _threeModule.Object3D) owner.add(object);
        }
      }
      ...
      var vB = new _threeModule.Vector3();
      var vC = new _threeModule.Vector3();
      var uvA = new _threeModule.Vector2();
      var uvB = new _threeModule.Vector2();
      var uvC = new _threeModule.Vector2();
      ...
      function computeAttributeFromIndexedData(coordIndex, index, data, itemSize) {
        ...
        return new _threeModule.Float32BufferAttribute(array, itemSize);
      }
      ...
      function computeAttributeFromFaceData(index, faceData) {
        ...
        return new _threeModule.Float32BufferAttribute(array, 3);
      }
      ...
      function toNonIndexedAttribute(indices, attribute) {
        ...
        return new _threeModule.Float32BufferAttribute(array2, itemSize);
      }

      var ab = new _threeModule.Vector3();
      var cb = new _threeModule.Vector3();
      ...
      function computeNormalAttribute(index, coord, creaseAngle) {
        ...
        return new _threeModule.Float32BufferAttribute(normals, 3);
      }

      function weightedNormal(normals, vector, creaseAngle) {
        var normal = new _threeModule.Vector3();
      ...
      function toColorArray(colors) {
        ...
        for (var i = 0, l = colors.length; i < l; i += 3) {
          array.push(new _threeModule.Color(colors[i], colors[i + 1], colors[i + 2]));
        }
      ...
      function paintFaces(geometry, radius, angles, colors, topDown) {
        ...
        for (var i = 0, l = colors.length; i < l; i++) {
          ...
          var point = new _threeModule.Vector3();
        ...
        var colorAttribute = new _threeModule.BufferAttribute(new Float32Array(geometry.attributes.position.count * 3), 3);
        var position = new _threeModule.Vector3();
      ...
      var textureLoader = new _threeModule.TextureLoader(this.manager);
      textureLoader.setPath(this.resourcePath || path).setCrossOrigin(this.crossOrigin); // create JSON representing the tree structure of the VRML asset

      var tree = generateVRMLTree(data); // check version (only 2.0 is supported)
  ...
  function VRMLLexer(tokens) {
    this.lexer = new _chevrotainModuleMin.chevrotain.Lexer(tokens);
  }
  ...
  function VRMLParser(tokenVocabulary) {
    _chevrotainModuleMin.chevrotain.Parser.call(this, tokenVocabulary);
  ...
  VRMLParser.prototype = Object.create(_chevrotainModuleMin.chevrotain.Parser.prototype);
