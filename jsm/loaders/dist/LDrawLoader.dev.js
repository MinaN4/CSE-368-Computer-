...
var LDrawLoader = function () {
  ...
  var tempVec0 = new _threeModule.Vector3();
  var tempVec1 = new _threeModule.Vector3();
  ...
  function createObject(elements, elementSize, isConditionalSegments) {
    ...
    bufferGeometry.setAttribute('position', new _threeModule.Float32BufferAttribute(positions, 3));
    ...
    if (elementSize === 2) {
      object3d = new _threeModule.LineSegments(bufferGeometry, materials);
    } else if (elementSize === 3) {
      object3d = new _threeModule.Mesh(bufferGeometry, materials);
    }
    ...
    if (isConditionalSegments) {
      ...
      bufferGeometry.setAttribute('control0', new _threeModule.BufferAttribute(controlArray0, 3, false));
      bufferGeometry.setAttribute('control1', new _threeModule.BufferAttribute(controlArray1, 3, false));
      bufferGeometry.setAttribute('direction', new _threeModule.BufferAttribute(directionArray, 3, false));
    }
  ...
  function LDrawLoader(manager) {
    _threeModule.Loader.call(this, manager); // This is a stack of 'parse scopes' with one level per subobject loaded file.
  ...
  LDrawLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
    ...
    newParseScopeLevel: function newParseScopeLevel(materials) {
      ...
      var newParseScope = {
        ...
        currentMatrix: new _threeModule.Matrix4(),
    ...
    parseColourMetaDirective: function parseColourMetaDirective(lineParser) {
      ...
      switch (finishType) {
        case LDrawLoader.FINISH_TYPE_DEFAULT:
          material = new _threeModule.MeshStandardMaterial({
            color: colour,
            roughness: 0.3,
            envMapIntensity: 0.3,
            metalness: 0
        ...
        case LDrawLoader.FINISH_TYPE_PEARLESCENT:
          ...
          var specular = new _threeModule.Color(colour);
      ...
      if (!edgeMaterial) {
        ...
        edgeMaterial = new _threeModule.LineBasicMaterial({
          color: edgeColour,
        ...
        edgeMaterial.userData.conditionalEdgeMaterial = new _threeModule.ShaderMaterial({
          vertexShader: conditionalLineVertShader,
          fragmentShader: conditionalLineFragShader,
          uniforms: {
            diffuse: {
              value: new _threeModule.Color(edgeColour)
            },
            opacity: {
              value: alpha
            }
    ...
    objectParse: function objectParse(text) {
      ...
      function parseVector(lp) {
        var v = new _threeModule.Vector3(parseFloat(lp.getToken()), parseFloat(lp.getToken()), parseFloat(lp.getToken()));
      ...
      for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
        ...
        switch (lineType) {
                ...
                case '!LDRAW_ORG':
                  ...
                  if (!parsingEmbeddedFiles) {
                    ...
                    if (isRoot || scope.separateObjects && !isPrimitiveType(type)) {
                      currentParseScope.groupObject = new _threeModule.Group();
          ...
          case '1':
            ...
            var matrix = new _threeModule.Matrix4().set(m0, m1, m2, posX, m3, m4, m5, posY, m6, m7, m8, posZ, 0, 0, 0, 1);
          ...
          case '3':
            ...
            faceNormal = new _threeModule.Vector3().crossVectors(tempVec0, tempVec1).normalize();
            triangles.push({
              material: material,
              colourCode: material.userData.code,
              v0: v0,
    ...
    processObject: function processObject(text, onProcessed, subobject, url) {
      ...
      function loadSubobject(subobject) {
        ...
        var fileLoader = new _threeModule.FileLoader(scope.manager);
