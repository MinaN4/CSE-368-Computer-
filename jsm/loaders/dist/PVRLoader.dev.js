...
var PVRLoader = function PVRLoader(manager) {
  _threeModule.CompressedTextureLoader.call(this, manager);
};

exports.PVRLoader = PVRLoader;
PVRLoader.prototype = Object.assign(Object.create(_threeModule.CompressedTextureLoader.prototype), {
...
PVRLoader._parseV3 = function (pvrDatas) {
  ...
  switch (pixelFormat) {
    case 0:
      // PVRTC 2bpp RGB
      bpp = 2;
      format = _threeModule.RGB_PVRTC_2BPPV1_Format;
      break;

    case 1:
      // PVRTC 2bpp RGBA
      bpp = 2;
      format = _threeModule.RGBA_PVRTC_2BPPV1_Format;
      break;

    case 2:
      // PVRTC 4bpp RGB
      bpp = 4;
      format = _threeModule.RGB_PVRTC_4BPPV1_Format;
      break;

    case 3:
      // PVRTC 4bpp RGBA
      bpp = 4;
      format = _threeModule.RGBA_PVRTC_4BPPV1_Format;
      break;
...
PVRLoader._parseV2 = function (pvrDatas) {
  ...
  if (formatFlags === PVRTC_4) {
    format = _hasAlpha ? _threeModule.RGBA_PVRTC_4BPPV1_Format : _threeModule.RGB_PVRTC_4BPPV1_Format;
    bpp = 4;
  } else if (formatFlags === PVRTC_2) {
    format = _hasAlpha ? _threeModule.RGBA_PVRTC_2BPPV1_Format : _threeModule.RGB_PVRTC_2BPPV1_Format;
    bpp = 2;
  } else {
