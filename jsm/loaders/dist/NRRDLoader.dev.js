...
var _gunzipModuleMin = require("../libs/gunzip.module.min.js");
...
NRRDLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function parse(data) {
    ...
    function parseHeader(header) {
      ...
      if (!headerObject.vectors) {
        ...
        headerObject.vectors = [new _threeModule.Vector3(1, 0, 0), new _threeModule.Vector3(0, 1, 0), new _threeModule.Vector3(0, 0, 1)]; //apply spacing if defined
    ...
    if (headerObject.encoding === 'gzip' || headerObject.encoding === 'gz') {
      ...
      var inflate = new _gunzipModuleMin.Zlib.Gunzip(new Uint8Array(_data)); // eslint-disable-line no-undef
    ...
    var spacingX = new _threeModule.Vector3(headerObject.vectors[0][0], headerObject.vectors[0][1], headerObject.vectors[0][2]).length();
    var spacingY = new _threeModule.Vector3(headerObject.vectors[1][0], headerObject.vectors[1][1], headerObject.vectors[1][2]).length();
    var spacingZ = new _threeModule.Vector3(headerObject.vectors[2][0], headerObject.vectors[2][1], headerObject.vectors[2][2]).length();
    volume.spacing = [spacingX, spacingY, spacingZ]; // Create IJKtoRAS matrix

    volume.matrix = new _threeModule.Matrix4();
    var _spaceX = 1;
    var _spaceY = 1;
    var _spaceZ = 1;
    ...
    volume.inverseMatrix = new _threeModule.Matrix4();
    volume.inverseMatrix.getInverse(volume.matrix);
    volume.RASDimensions = new _threeModule.Vector3(volume.xLength, volume.yLength, volume.zLength).applyMatrix4(volume.matrix).round().toArray().map(Math.abs); // .. and set the default threshold
