...
var _mmdparserModule = require("../libs/mmdparser.module.js");
...
var MMDLoader = function () {
  ...
  function MMDLoader(manager) {
    ...
    this.loader = new _threeModule.FileLoader(this.manager);
  ...
  MMDLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
    ...
    _getParser: function _getParser() {
      if (this.parser === null) {
        ...
        this.parser = new _mmdparserModule.MMDParser.Parser();
      }
  ...
  MeshBuilder.prototype = {
    ...
    build: function build(data, resourcePath, onProgress, onError) {
      ...
      var mesh = new _threeModule.SkinnedMesh(geometry, material);
      var skeleton = new _threeModule.Skeleton(initBones(mesh));
  ...
  GeometryBuilder.prototype = {
    ...
    build: function build(data) {
        ...
        for (var i = 0; i < data.metadata.ikCount; i++) {
          ...
          for (var j = 0, jl = ik.links.length; j < jl; j++) {
            ...
            if (data.bones[link.index].name.indexOf('ひざ') >= 0) {
              link.limitation = new _threeModule.Vector3(1.0, 0.0, 0.0);
            }
        ...
        for (var i = 0; i < data.metadata.boneCount; i++) {
          ...
          for (var j = 0, jl = ik.links.length; j < jl; j++) {
            ...
            if (ik.links[j].angleLimitation === 1) {
              ...
              rotationMin[0] = tmp1;
              rotationMin[1] = tmp2;
              link.rotationMin = new _threeModule.Vector3().fromArray(rotationMin);
              link.rotationMax = new _threeModule.Vector3().fromArray(rotationMax);
            }
      ...
      for (var i = 0; i < data.metadata.morphCount; i++) {
        ...
        var attribute = new _threeModule.Float32BufferAttribute(data.metadata.vertexCount * 3, 3);
      ...
      geometry.setAttribute('position', new _threeModule.Float32BufferAttribute(positions, 3));
      geometry.setAttribute('normal', new _threeModule.Float32BufferAttribute(normals, 3));
      geometry.setAttribute('uv', new _threeModule.Float32BufferAttribute(uvs, 2));
      geometry.setAttribute('skinIndex', new _threeModule.Uint16BufferAttribute(skinIndices, 4));
      geometry.setAttribute('skinWeight', new _threeModule.Float32BufferAttribute(skinWeights, 4));
  ...
  function MaterialBuilder(manager) {
    ...
    this.textureLoader = new _threeModule.TextureLoader(this.manager);
  ...
  MaterialBuilder.prototype = {
    ...
    /*, onProgress, onError */
      ...
      for (var i = 0; i < data.metadata.materialCount; i++) {
        ...
        params.color = new _threeModule.Color().fromArray(material.diffuse);
        params.opacity = material.diffuse[3];
        params.specular = new _threeModule.Color().fromArray(material.specular);
        params.emissive = new _threeModule.Color().fromArray(material.ambient);
        ...
        params.blending = _threeModule.CustomBlending;
        params.blendSrc = _threeModule.SrcAlphaFactor;
        params.blendDst = _threeModule.OneMinusSrcAlphaFactor;
        params.blendSrcAlpha = _threeModule.SrcAlphaFactor;
        params.blendDstAlpha = _threeModule.DstAlphaFactor; // side

        if (data.metadata.format === 'pmx' && (material.flag & 0x1) === 1) {
          params.side = _threeModule.DoubleSide;
        } else {
          params.side = params.opacity === 1.0 ? _threeModule.FrontSide : _threeModule.DoubleSide;
        }
        ...
        if (data.metadata.format === 'pmd') {
          ...
          if (material.fileName) {
            ...
            if (fileNames.length > 1) {
              ...
              params.combine = extension === '.sph' ? _threeModule.MultiplyOperation : _threeModule.AddOperation;
            }
          } // gradientMap
          ...
          if (material.envTextureIndex !== -1 && (material.envFlag === 1 || material.envFlag == 2)) {
            ...
            params.combine = material.envFlag === 1 ? _threeModule.MultiplyOperation : _threeModule.AddOperation;
          } // gradientMap
        ...
        materials.push(new _threeModule.MeshToonMaterial(params));
      }
    ...
    _loadTexture: function _loadTexture(filePath, textures, params, onProgress, onError) {
      ...
      var texture = loader.load(fullPath, function (t) {
        ...
        if (params.isToonTexture === true) {
          ...
          t.magFilter = _threeModule.NearestFilter;
          t.minFilter = _threeModule.NearestFilter;
        }

        t.flipY = false;
        t.wrapS = _threeModule.RepeatWrapping;
        t.wrapT = _threeModule.RepeatWrapping;
      ...
      if (params.sphericalReflectionMapping === true) {
        texture.mapping = _threeModule.SphericalReflectionMapping;
      }
  ...
  AnimationBuilder.prototype = {
    ...
    build: function build(vmd, mesh) {
      ...
      return new _threeModule.AnimationClip('', -1, tracks);
    },
    ...
    buildSkeletalAnimation: function buildSkeletalAnimation(vmd, mesh) {
      ...
      for (var key in motions) {
        ...
        tracks.push(this._createTrack(targetName + '.position', _threeModule.VectorKeyframeTrack, times, positions, pInterpolations));
        tracks.push(this._createTrack(targetName + '.quaternion', _threeModule.QuaternionKeyframeTrack, times, rotations, rInterpolations));
      }
    ...
    buildMorphAnimation: function buildMorphAnimation(vmd, mesh) {
      ...
      for (var key in morphs) {
        ...
        tracks.push(new _threeModule.NumberKeyframeTrack('.morphTargetInfluences[' + morphTargetDictionary[key] + ']', times, values));
      }
    ...
    buildCameraAnimation: function buildCameraAnimation(vmd) {
      ...
      var center = new _threeModule.Vector3();
      ...
      tracks.push(this._createTrack('target.position', _threeModule.VectorKeyframeTrack, times, centers, cInterpolations));
      tracks.push(this._createTrack('.quaternion', _threeModule.QuaternionKeyframeTrack, times, quaternions, qInterpolations));
      tracks.push(this._createTrack('.position', _threeModule.VectorKeyframeTrack, times, positions, pInterpolations));
      tracks.push(this._createTrack('.fov', _threeModule.NumberKeyframeTrack, times, fovs, fInterpolations));
      return new _threeModule.AnimationClip('', -1, tracks);
    },
    // private method
  ...
  CubicBezierInterpolation.prototype = Object.assign(Object.create(_threeModule.Interpolant.prototype), {
    ...
    interpolate_: function interpolate_(i1, t0, t, t1) {
      ...
      if (stride === 4) {
        ...
        _threeModule.Quaternion.slerpFlat(result, 0, values, offset0, values, offset1, ratio);
      } else if (stride === 3) {
        // Vector3
        for (var i = 0; i !== stride; ++i) {
