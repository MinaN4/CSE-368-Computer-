...
var _ColladaLoader = require("../loaders/ColladaLoader.js");
...
KMZLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function parse(data) {
    ...
    var manager = new _threeModule.LoadingManager();
    ...
    if (zip.files['doc.kml']) {
      ...
      if (model) {
        var loader = new _ColladaLoader.ColladaLoader(manager);
