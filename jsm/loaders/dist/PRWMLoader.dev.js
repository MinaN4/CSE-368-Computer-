...
var PRWMLoader = function () {
  ...
  PRWMLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
    ...
    parse: function parse(arrayBuffer) {
      var data = decodePrwm(arrayBuffer),
          ...
          bufferGeometry = new _threeModule.BufferGeometry(),
          attribute,
          i;

      for (i = 0; i < attributesKey.length; i++) {
        attribute = data.attributes[attributesKey[i]];
        bufferGeometry.setAttribute(attributesKey[i], new _threeModule.BufferAttribute(attribute.values, attribute.cardinality, attribute.normalized));
      }

      if (data.indices !== null) {
        bufferGeometry.setIndex(new _threeModule.BufferAttribute(data.indices, 1));
      }
