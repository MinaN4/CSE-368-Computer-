...
ThreeMFLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function parse(data) {
    ...
    function loadDocument(data) {
      ...
      var relsFileText = _threeModule.LoaderUtils.decodeText(relsView);
      ...
      for (var i = 0; i < modelPartNames.length; i++) {
        ...
        var fileText = _threeModule.LoaderUtils.decodeText(view);
    ...
    function parseColorGroupNode(colorGroupNode) {
      ...
      var colors = [];
      var colorObject = new _threeModule.Color();
    ...
    function buildTexture(texture2dgroup, objects, modelData, textureData) {
      ...
      if (texture2d) {
        ...
        texture.encoding = _threeModule.sRGBEncoding; // texture parameters
        ...
        switch (texture2d.tilestyleu) {
          ...
          case 'mirror':
            texture.wrapS = _threeModule.MirroredRepeatWrapping;
            break;

          case 'none':
          case 'clamp':
            texture.wrapS = _threeModule.ClampToEdgeWrapping;
            break;
        ...
        switch (texture2d.tilestylev) {
          ...
          case 'mirror':
            texture.wrapT = _threeModule.MirroredRepeatWrapping;
            break;

          case 'none':
          case 'clamp':
            texture.wrapT = _threeModule.ClampToEdgeWrapping;
            break;
        ...
        switch (texture2d.filter) {
          case 'auto':
            ...
            texture.minFilter = _threeModule.LinearMipmapLinearFilter;
            break;
    ...
    function buildBasematerialsMeshes(basematerials, triangleProperties, modelData, meshData, textureData, objectData) {
      ...
      for (var i = 0, l = keys.length; i < l; i++) {
        ...
        geometry.setAttribute('position', new _threeModule.Float32BufferAttribute(positionData, 3)); //
    ...
    function buildTexturedMesh(texture2dgroup, triangleProperties, modelData, meshData, textureData, objectData) {
      ...
      geometry.setAttribute('position', new _threeModule.Float32BufferAttribute(positionData, 3));
      geometry.setAttribute('uv', new _threeModule.Float32BufferAttribute(uvData, 2)); // material
    ...
    function buildVertexColorMesh(colorgroup, triangleProperties, modelData, meshData) {
      ...
      geometry.setAttribute('position', new _threeModule.Float32BufferAttribute(positionData, 3));
      geometry.setAttribute('color', new _threeModule.Float32BufferAttribute(colorData, 3)); // material
    ...
    function buildDefaultMesh(meshData) {
      var geometry = new _threeModule.BufferGeometry();
      geometry.setIndex(new _threeModule.BufferAttribute(meshData['triangles'], 1));
      geometry.setAttribute('position', new _threeModule.BufferAttribute(meshData['vertices'], 3));
      var material = new _threeModule.MeshPhongMaterial({
        color: 0xaaaaff,
        flatShading: true
      });
    ...
    function buildComposite(compositeData, objects, modelData, textureData) {
      var composite = new _threeModule.Group();
      ...
      for (var j = 0; j < compositeData.length; j++) {
        ...
        var object3D = build.clone(); // apply component transfrom
