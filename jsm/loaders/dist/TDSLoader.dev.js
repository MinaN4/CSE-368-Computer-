...
TDSLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
  ...
  parse: function parse(arraybuffer, path) {
    this.group = new _threeModule.Group();
    this.position = 0;
    this.materials = [];
    this.meshes = [];
  ...
  readMaterialEntry: function readMaterialEntry(data, path) {
    ...
    while (next !== 0) {
      if (next === MAT_NAME) {
        ...
        material.blending = _threeModule.AdditiveBlending;
  ...
  readMesh: function readMesh(data) {
    ...
    while (next !== 0) {
      if (next === POINT_ARRAY) {
        ...
        var matrix = new _threeModule.Matrix4(); //X Line
        ...
        matrix.transpose();
        var inverse = new _threeModule.Matrix4();
  ...
  readMap: function readMap(data, path) {
    ...
    var next = this.nextChunk(data, chunk);
    var texture = {};
    var loader = new _threeModule.TextureLoader(this.manager);
