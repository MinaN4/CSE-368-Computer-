...
MaterialHandler.prototype = {
  ...
  createDefaultMaterials: function createDefaultMaterials(overrideExisting) {
    var defaultMaterial = new _threeModule.MeshStandardMaterial({
      color: 0xDCF1FF
    });
    defaultMaterial.name = 'defaultMaterial';
    var defaultVertexColorMaterial = new _threeModule.MeshStandardMaterial({
      color: 0xDCF1FF
    });
    defaultVertexColorMaterial.name = 'defaultVertexColorMaterial';
    defaultVertexColorMaterial.vertexColors = _threeModule.VertexColors;
    var defaultLineMaterial = new _threeModule.LineBasicMaterial();
    defaultLineMaterial.name = 'defaultLineMaterial';
    var defaultPointMaterial = new _threeModule.PointsMaterial({
      size: 0.1
    });
  ...
  addPayloadMaterials: function addPayloadMaterials(materialPayload) {
    ...
    if (materials !== undefined && materials !== null && Object.keys(materials).length > 0) {
      var loader = new _threeModule.MaterialLoader();
      var materialJson;
