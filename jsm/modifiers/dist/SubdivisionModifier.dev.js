...
(function () {
  ...
  function newFace(newFaces, a, b, c, materialIndex) {
    newFaces.push(new _threeModule.Face3(a, b, c, undefined, undefined, materialIndex));
  }
  ...
  SubdivisionModifier.prototype.smooth = function (geometry) {
    ...
    for (i in sourceEdges) {
      ...
      newEdge = new _threeModule.Vector3();
    ...
    newFaces = [];
    var uv, x0, x1, x2;
    var x3 = new _threeModule.Vector2();
    var x4 = new _threeModule.Vector2();
    var x5 = new _threeModule.Vector2();
