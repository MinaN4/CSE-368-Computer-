...
(function () {
  ...
  SimplifyModifier.prototype.modify = function (geometry, count) {
    if (geometry.isBufferGeometry) {
      geometry = new _threeModule.Geometry().fromBufferGeometry(geometry);
    }
    ...
    var simplifiedGeometry = new _threeModule.BufferGeometry();
    var position = [];
    var index = []; //
    ...
    simplifiedGeometry.setAttribute('position', new _threeModule.Float32BufferAttribute(position, 3));
