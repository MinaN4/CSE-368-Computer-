...
var AnaglyphEffect = function AnaglyphEffect(renderer, width, height) {
  ...
  this.colorMatrixLeft = new _threeModule.Matrix3().fromArray([1.0671679973602295, -0.0016435992438346148, 0.0001777536963345483, // r out
  -0.028107794001698494, -0.00019593400065787137, -0.0002875397040043026, // g out
  -0.04279090091586113, 0.000015809757314855233, -0.00024287120322696865 // b out
  ]); //		red						green 						blue  						in

  this.colorMatrixRight = new _threeModule.Matrix3().fromArray([-0.0355340838432312, -0.06440307199954987, 0.018319187685847282, // r out
  ...
  var _renderTargetL = new _threeModule.WebGLRenderTarget(width, height, _params);

  var _renderTargetR = new _threeModule.WebGLRenderTarget(width, height, _params);
  ...
  var _mesh = new _threeModule.Mesh(new _threeModule.PlaneBufferGeometry(2, 2), _material);
