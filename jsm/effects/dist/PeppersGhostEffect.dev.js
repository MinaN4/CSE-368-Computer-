...
var PeppersGhostEffect = function PeppersGhostEffect(renderer) {
  ...
  var _cameraF = new _threeModule.PerspectiveCamera(); //front


  var _cameraB = new _threeModule.PerspectiveCamera(); //back


  var _cameraL = new _threeModule.PerspectiveCamera(); //left


  var _cameraR = new _threeModule.PerspectiveCamera(); //right


  var _position = new _threeModule.Vector3();

  var _quaternion = new _threeModule.Quaternion();

  var _scale = new _threeModule.Vector3(); // Initialization
