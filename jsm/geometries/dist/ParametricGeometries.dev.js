...
ParametricGeometries.TubeGeometry = function (path, segments, radius, segmentsRadius, closed, debug) {
  ...
  if (debug) this.debug = new _threeModule.Object3D();
  var scope = this,
  ...
  var ParametricTube = function ParametricTube(u, v, target) {
    ...
    if (scope.debug) {
      scope.debug.add(new _threeModule.ArrowHelper(tangent, pos, radius, 0x0000ff));
      scope.debug.add(new _threeModule.ArrowHelper(normal, pos, radius, 0xff0000));
      scope.debug.add(new _threeModule.ArrowHelper(binormal, pos, radius, 0x00ff00));
    }
  ...
  _threeModule.ParametricGeometry.call(this, ParametricTube, segments, segmentsRadius);
};

ParametricGeometries.TubeGeometry.prototype = Object.create(_threeModule.Geometry.prototype);
...
ParametricGeometries.TorusKnotGeometry = function (radius, tube, segmentsT, segmentsR, p, q) {
  ...
  TorusKnotCurve.prototype = Object.create(_threeModule.Curve.prototype);
...
ParametricGeometries.TorusKnotGeometry.prototype = Object.create(_threeModule.Geometry.prototype);
...
ParametricGeometries.SphereGeometry = function (size, u, v) {
  ...
  _threeModule.ParametricGeometry.call(this, sphere, u, v);
};

ParametricGeometries.SphereGeometry.prototype = Object.create(_threeModule.Geometry.prototype);
...
ParametricGeometries.PlaneGeometry = function (width, depth, segmentsWidth, segmentsDepth) {
  ...
  _threeModule.ParametricGeometry.call(this, plane, segmentsWidth, segmentsDepth);
};

ParametricGeometries.PlaneGeometry.prototype = Object.create(_threeModule.Geometry.prototype);
