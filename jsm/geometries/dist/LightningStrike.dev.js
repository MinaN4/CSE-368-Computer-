...
LightningStrike.prototype = Object.create(_threeModule.BufferGeometry.prototype);
...
LightningStrike.prototype.init = function (rayParameters) {
  ...
  this.forwards = new _threeModule.Vector3();
  this.forwardsFill = new _threeModule.Vector3();
  this.side = new _threeModule.Vector3();
  this.down = new _threeModule.Vector3();
  this.middlePos = new _threeModule.Vector3();
  this.middleLinPos = new _threeModule.Vector3();
  this.newPos = new _threeModule.Vector3();
  this.vPos = new _threeModule.Vector3();
  this.cross1 = new _threeModule.Vector3();
};
...
LightningStrike.prototype.createMesh = function () {
  ...
  this.fillMesh(0);
  this.setIndex(new _threeModule.Uint32BufferAttribute(this.indices, 1));
  this.positionAttribute = new _threeModule.Float32BufferAttribute(this.vertices, 3);
  this.setAttribute('position', this.positionAttribute);

  if (this.generateUVs) {
    this.uvsAttribute = new _threeModule.Float32BufferAttribute(new Float32Array(this.uvs), 2);
    this.setAttribute('uv', this.uvsAttribute);
  }

  if (!this.isStatic) {
    this.index.usage = _threeModule.DynamicDrawUsage;
    this.positionAttribute.usage = _threeModule.DynamicDrawUsage;

    if (this.generateUVs) {
      this.uvsAttribute.usage = _threeModule.DynamicDrawUsage;
    }
...
LightningStrike.prototype.fractalRay = function (time, segmentCallback) {
  ...
  for (var subrayIndex = 0; subrayIndex < this.numSubrays; subrayIndex++) {
    ...
    subray.endPropagationTime = _threeModule.Math.lerp(subray.birthTime, subray.deathTime, subray.propagationTimeFactor);
    subray.beginVanishingTime = _threeModule.Math.lerp(subray.deathTime, subray.birthTime, 1 - subray.vanishingTimeFactor);
...
LightningStrike.prototype.createDefaultSubrayCreationCallbacks = function () {
  ...
  this.onDecideSubrayCreation = function (segment, lightningStrike) {
    ...
    var phase0 = lightningStrike.rayParameters.isEternal && subray.recursion == 0 ? -random1() * period : _threeModule.Math.lerp(subray.birthTime, subray.endPropagationTime, segment.fraction0) - random1() * period;
  ...
  var vec1Pos = new _threeModule.Vector3();
  var vec2Forward = new _threeModule.Vector3();
  var vec3Side = new _threeModule.Vector3();
  var vec4Up = new _threeModule.Vector3();
...
LightningStrike.prototype.createSubray = function () {
  return {
    ...
    maxIterations: 0,
    recursion: 0,
    pos0: new _threeModule.Vector3(),
    pos1: new _threeModule.Vector3(),
    linPos0: new _threeModule.Vector3(),
    linPos1: new _threeModule.Vector3(),
    up0: new _threeModule.Vector3(),
    up1: new _threeModule.Vector3(),
    radius0: 0,
    radius1: 0,
    birthTime: 0,
    deathTime: 0,
...
LightningStrike.prototype.copy = function (source) {
  _threeModule.BufferGeometry.prototype.copy.call(this, source);
