...
exports.TeapotBufferGeometry = void 0;
...
var TeapotBufferGeometry = function TeapotBufferGeometry(size, segments, bottom, lid, body, fitLid, blinn) {
  ...
  var ms = new _threeModule.Matrix4();
  ...
  var sdir = [];
  var tdir = [];
  var norm = new _threeModule.Vector3();
  var tcoord;
  var sstep, tstep;
  var vertPerRow;
  var s, t, sval, tval, p;
  var dsval = 0;
  var dtval = 0;
  var normOut = new _threeModule.Vector3();
  var v1, v2, v3, v4;
  var gmx = new _threeModule.Matrix4();
  var tmtx = new _threeModule.Matrix4();
  var vsp = new _threeModule.Vector4();
  var vtp = new _threeModule.Vector4();
  var vdsp = new _threeModule.Vector4();
  var vdtp = new _threeModule.Vector4();
  var vsdir = new _threeModule.Vector3();
  var vtdir = new _threeModule.Vector3();
  var mst = ms.clone();
  ...
  for (i = 0; i < 3; i++) {
    mgm[i] = new _threeModule.Matrix4();
  }
  ...
  this.setIndex(new _threeModule.BufferAttribute(indices, 1));
  this.setAttribute('position', new _threeModule.BufferAttribute(vertices, 3));
  this.setAttribute('normal', new _threeModule.BufferAttribute(normals, 3));
  this.setAttribute('uv', new _threeModule.BufferAttribute(uvs, 2));
  this.computeBoundingSphere();
};

exports.TeapotBufferGeometry = TeapotBufferGeometry;
TeapotBufferGeometry.prototype = Object.create(_threeModule.BufferGeometry.prototype);
