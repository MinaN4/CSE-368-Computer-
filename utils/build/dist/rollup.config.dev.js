...
var _rollupPluginBuble = _interopRequireDefault(require("rollup-plugin-buble"));
  ...
  return {
    transform: function transform(code, id) {
      ...
      code = code.replace(/\/\* glsl \*\/\`((.*|\n|\r\n)*)\`/, function (match, p1) {
        return JSON.stringify(p1.trim().replace(/\r/g, '').replace(/[ \t]*\/\/.*\n/g, '') // remove //
...
var _default = [{
  input: 'src/Three.js',
  plugins: [glconstants(), glsl(), (0, _rollupPluginBuble["default"])({
    transforms: {
      arrow: false,
      classes: true
    }
